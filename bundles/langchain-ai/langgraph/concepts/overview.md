...
详见 [Pregel 引擎](/langchain-ai/langgraph/concepts/pregel-engine)。
...
详见 [通道系统](/langchain-ai/langgraph/concepts/channels)。
...
详见 [检查点机制](/langchain-ai/langgraph/concepts/checkpointing)。
...
详见 [错误处理与中断](/langchain-ai/langgraph/concepts/error-handling)。
...
详见 [流式处理](/langchain-ai/langgraph/concepts/streaming)。
...
详见 [消息图](/langchain-ai/langgraph/concepts/message-graph)。
...
- [状态图](/langchain-ai/langgraph/concepts/state-graph) — StateGraph 的使用模式
- [通道系统](/langchain-ai/langgraph/concepts/channels) — 通道类型与 reducer
- [Pregel 引擎](/langchain-ai/langgraph/concepts/pregel-engine) — BSP 执行模型
- [检查点机制](/langchain-ai/langgraph/concepts/checkpointing) — 持久化与恢复
- [消息图](/langchain-ai/langgraph/concepts/message-graph) — 聊天应用构建
- [流式处理](/langchain-ai/langgraph/concepts/streaming) — 流模式详解
- [错误处理](/langchain-ai/langgraph/concepts/error-handling) — 重试、中断与恢复
