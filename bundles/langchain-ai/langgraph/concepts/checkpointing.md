...
- [Pregel 引擎](/langchain-ai/langgraph/concepts/pregel-engine) — 检查点在超步中的角色
- [通道系统](/langchain-ai/langgraph/concepts/channels) — DeltaChannel 与通道检查点表示
- [错误处理](/langchain-ai/langgraph/concepts/error-handling) — 中断与恢复机制
- [API 参考](/langchain-ai/langgraph/references/checkpoint-persistence) — 检查点完整 API
