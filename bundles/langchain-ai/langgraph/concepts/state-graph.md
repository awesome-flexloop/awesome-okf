...
- [通道系统](/langchain-ai/langgraph/concepts/channels) — 状态键如何映射到通道
- [Pregel 引擎](/langchain-ai/langgraph/concepts/pregel-engine) — 编译后的执行模型
- [检查点机制](/langchain-ai/langgraph/concepts/checkpointing) — 持久化与恢复
- [错误处理](/langchain-ai/langgraph/concepts/error-handling) — 重试与错误处理器
- [API 参考](/langchain-ai/langgraph/references/graph-state) — StateGraph 完整 API
