...
- [状态图](/langchain-ai/langgraph/concepts/state-graph) — Schema 如何映射到通道
- [Pregel 引擎](/langchain-ai/langgraph/concepts/pregel-engine) — 通道在超步中的生命周期
- [检查点机制](/langchain-ai/langgraph/concepts/checkpointing) — DeltaChannel 的持久化优化
- [API 参考](/langchain-ai/langgraph/references/channels-pregel) — 通道完整 API
