...
- [Runnable 接口](/langchain-ai/langchainjs/concepts/runnable-interface) — 模板作为 Runnable 的组合能力
- [消息系统](/langchain-ai/langchainjs/concepts/message-system) — BaseMessage 类型
- [构建 LCEL 链示例](/langchain-ai/langchainjs/examples/lcel-chain) — Prompt → Model → Parser
