...
- [消息类型](/langchain-ai/langchain/concepts/message-types) —— ToolCall 与 ToolMessage 的数据结构
- [聊天模型](/langchain-ai/langchain/concepts/chat-model) —— bind_tools 将工具绑定到模型
- [Runnable 协议](/langchain-ai/langchain/concepts/runnable-protocol) —— BaseTool 本身是 RunnableSerializable
- [回调系统](/langchain-ai/langchain/concepts/callback-system) —— 工具执行触发 on_tool_start/end/error
