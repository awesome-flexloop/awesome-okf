...
- [消息类型](/langchain-ai/langchain/concepts/message-types) —— AIMessage 是输出，HumanMessage/SystemMessage 是输入
- [提示词系统](/langchain-ai/langchain/concepts/prompt-system) —— ChatPromptValue 是输入桥梁
- [工具抽象](/langchain-ai/langchain/concepts/tool-abstraction) —— bind_tools 接受 BaseTool
- [Runnable 协议](/langchain-ai/langchain/concepts/runnable-protocol) —— BaseChatModel 是 RunnableSerializable
- [输出解析器](/langchain-ai/langchain/concepts/output-parser) —— with_structured_output 的底层机制
