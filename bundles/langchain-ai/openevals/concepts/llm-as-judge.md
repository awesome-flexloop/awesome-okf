...
- [精确评测器](/langchain-ai/openevals/concepts/exact-evaluators) — 确定性评测，无需 LLM
- [API 参考](/langchain-ai/openevals/references/api) — `createLLMAsJudge` 完整参数说明
- [基础评测示例](/langchain-ai/openevals/examples/basic-evaluation) — 包含 LLM-as-Judge 的完整代码
