...
- [核心 API](/langchain-ai/deepagents/references/api) — `create_deep_agent(backend=)` 参数
- [Todo 与上下文管理](/langchain-ai/deepagents/concepts/todo-context) — 摘要卸载如何使用后端
- [lca-deepagents 变体](/langchain-ai/deepagents/references/lca-variant) — 课程示例中的后端使用模式
