...
description: "Executable Books 新一代技术文档工具链源码级中文教程——8个知识束，覆盖MyST解析引擎、CLI工具链、语法扩展、多格式导出、Notebook执行、交互式代码运行、JupyterLab集成与主题系统"
total_bundles: 8
---
...
> ⚠️ 本文档为构建中占位文件，最终统计数据将在所有知识束生成完成后更新。
