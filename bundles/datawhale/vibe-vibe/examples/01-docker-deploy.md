...
- [多语言文档架构](/datawhale/vibe-vibe/concepts/03-multilingual-docs-architecture.md)：VitePress 双语构建、首页重定向、交互组件体系。
- [Vibe 开发理念](/datawhale/vibe-vibe/concepts/01-vibe-coding-philosophy.md)：站点承载的教学内容与 AI 创造工作流。
