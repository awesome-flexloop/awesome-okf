...
- [Monorepo 架构](/datawhale/deepagents/concepts/monorepo-architecture) 描述了 SDK 包在仓库中的位置。
- [Code终端编码Agent](/datawhale/deepagents/concepts/code-module) 在 SDK 之上构建编码特定的中间件/工具/审批栈。
- [ACP协议集成](/datawhale/deepagents/concepts/acp-protocol) 将编译后的 Agent 图适配为 ACP 服务器。
