...
本章从算法性质出发推导泛化保证，是[稳定性](/datawhale/key-book/concepts/stability)概念的主体章节，也是 PAC 学习与统计学习理论统一的关键。
...
- [第 4 章：泛化界](/datawhale/key-book/references/chapter4)：VC 维路径的泛化分析
- [第 8 章：遗憾界](/datawhale/key-book/references/chapter8)：在线学习中稳定性与可塑性的张力
