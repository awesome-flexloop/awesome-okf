...
本章系统推导有限和无限假设空间的泛化误差界，是[泛化界](/datawhale/key-book/concepts/generalization-bound)概念的主体章节。
...
- [第 3 章：复杂性分析](/datawhale/key-book/references/chapter3)：VC 维与 Rademacher 复杂度的定义
- [第 5 章：稳定性](/datawhale/key-book/references/chapter5)：算法依赖的替代泛化保证
