...
- [计算复杂度](/datawhale/key-book/concepts/computational-complexity)决定 PAC 学习的样本与时间代价
- [泛化界](/datawhale/key-book/concepts/generalization-bound)是 PAC 可学性的直接技术手段
- [稳定性](/datawhale/key-book/concepts/stability)提供了不依赖假设空间计数的可学性判据（定理 5.4 证明稳定性与不可知 PAC 可学等价）

## 参见

- [第 2 章：可学性](/datawhale/key-book/references/chapter2)
- [3-DNF 不可学案例](/datawhale/key-book/examples/pac-3dnf)
