...
3. **稳定性 vs 可塑性**：在线学习需要算法适应新数据（可塑性），与稳定性目标存在根本张力，需用[遗憾界](/datawhale/key-book/concepts/regret-bound)分析。

## 与其他概念的关系

- [泛化界](/datawhale/key-book/concepts/generalization-bound)：稳定性提供算法依赖的泛化保证，是 VC 维方法的替代
- [可学性](/datawhale/key-book/concepts/learnability)：定理 5.4 建立稳定性与不可知 PAC 可学性的等价
- [遗憾界](/datawhale/key-book/concepts/regret-bound)：在线学习中稳定性与可塑性的张力由遗憾分析平衡

## 参见

- [第 5 章：稳定性](/datawhale/key-book/references/chapter5)
