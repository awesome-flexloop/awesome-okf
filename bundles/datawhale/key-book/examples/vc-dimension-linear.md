...
本案例通过二维线性分类器直观展示 VC 维的含义，是理解[计算复杂度](/datawhale/key-book/concepts/computational-complexity)中"有效自由度"的经典示例。
...
- [泛化界](/datawhale/key-book/concepts/generalization-bound)
