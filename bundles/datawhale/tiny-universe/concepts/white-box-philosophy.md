...
这一理念在 [TinyDiffusion](/datawhale/tiny-universe/concepts/tiny-diffusion)、[TinyRAG](/datawhale/tiny-universe/concepts/tiny-rag)、[TinyAgent](/datawhale/tiny-universe/concepts/tiny-agent)、[TinyLLM](/datawhale/tiny-universe/concepts/tiny-llm) 等概念中均有具体体现。
