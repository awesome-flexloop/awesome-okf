...
- [/deepseek/deep-spec/concepts/dspark-model](/deepseek/deep-spec/concepts/dspark-model) — DSpark 架构对比
- [/deepseek/deep-spec/references/model-api](/deepseek/deep-spec/references/model-api) — 模型 API 参考（FusedLogSoftmaxLoss、模型类完整签名）
