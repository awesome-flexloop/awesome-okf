...
参见 [/deepseek/deep-gemm/references/mega-moe](/deepseek/deep-gemm/references/mega-moe)。

---

## 七、Runtime 配置 API

参见 [/deepseek/deep-gemm/references/runtime-config](/deepseek/deep-gemm/references/runtime-config)。
