...
- [/deepseek/deep-gemm/concepts/fp8-gemm](/deepseek/deep-gemm/concepts/fp8-gemm) — FP8/FP4 量化方案
- [/deepseek/deep-gemm/concepts/grouped-gemm](/deepseek/deep-gemm/concepts/grouped-gemm) — 分组 GEMM（非融合 MoE 方案）
- [/deepseek/deep-ep/](/deepseek/deep-ep/) — DeepEP 通信库（非融合方案）
