...
- **[DeepGEMM](/deepseek/deep-gemm/)**：C++ JIT GEMM 核函数库，负责核心矩阵乘法
- **[DeepEP](/deepseek/deep-ep/)**：专家并行通信库，负责跨节点 all-to-all
...
| 项目 | 关系 |
|---|---|
| [DeepGEMM](/deepseek/deep-gemm/) | DeepSeek 高性能 C++ JIT GEMM 库，TileKernels 为其提供量化、MoE dispatch/combine 等补充算子 |
| [DeepEP](/deepseek/deep-ep/) | DeepSeek 专家并行通信库，处理跨节点 all-to-all，TileKernels 处理本地 dispatch/combine |
