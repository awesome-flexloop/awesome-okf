...
>
> 当前共 **289 个知识包**，按技术生态分为 **13 个技术域、35 个分组**。
...
flowchart TD
    ...
    think["💭 think/ 思想与理论：psi · laozi · classics · sexology · yangsheng"]
    meta -->|"规范约束"| py
    py -->|"语言底座"| build
    rust -->|"工具链底座"| build
    build --> doc
...
flowchart LR
    ...
    think["💭 think/：思想与理论（psi · laozi · classics · sexology · yangsheng 选读）"]
