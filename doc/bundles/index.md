...
flowchart TD
    ...
    sheke["👥 sheke/ 社会科学（38 束）：职场管理·亲密关系·性学经典·理财·营销·个人成长·AI 行业趋势"]
    yishu["🎤 yishu/ 艺术（9 束）：艺术疗愈六束（总览·美术·音乐·舞动戏剧·表达性·中国）·声乐教学两束（美通咽音·手势教学）·红歌教学一束（曲谱库·赏析·歌谱合规·柯尔文手势）"]
    jishu["⚙️ jishu/ 技术（423 束）：AI·文档工程·构建·通信·容器·数据·物联网等 17 生态分组"]
    meta -->|"规范约束"| jishu
...
| [📣 市场营销（Marketing）](sheke/marketing/index.md) | 2  | 营销实操通识——营销本质、STP 战略、定位与品牌、4P/4C 战术、顾客旅程、AARRR 增长、内容私域与合规底线，附工作坊与算例清单 |
...
### ⚙️ [技术](jishu/index.md) · 423 束 · 17 组

| 分组                                               | 束数  | 说明                                                                                                         |
| ------------------------------------------------ | --- | ---------------------------------------------------------------------------------------------------------- |
| [🤖 人工智能与大模型（ai）](jishu/ai/index.md)             | 204 | agnes-ai · ai-agent · langchain-ai · datawhale · coze · deepseek · trae · tencent · pocketflow · anthropic · mobile-use · tiktoken · ai-security · agent-industry-research · domestic-model-token-export 及工程方法论等直挂束 |
