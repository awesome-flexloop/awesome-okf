...
>
> 当前共 **503 个知识包**，按学科逻辑分为 **9 个技术域、57 个分组**（8 个学科域 + 1 个规范锚点）。
...
flowchart TD
    ...
    jishu["⚙️ jishu/ 技术（378 束）：AI·文档工程·构建·通信·容器·数据·物联网等 17 生态分组"]
    meta -->|"规范约束"| jishu
...
### ⚙️ [技术](jishu/index.md) · 378 束 · 17 组
...
| [📦 容器生态（containers）](jishu/containers/index.md) | 12  | OCI 运行时 · 存储驱动 · Podman 工具链 · podman-py Python SDK · AI 容器配方                                                                      |
