...
>
> 当前共 **557 个知识包**，按学科逻辑分为 **9 个技术域、59 个分组**（8 个学科域 + 1 个规范锚点）。
...
flowchart TD
    ...
    jishu["⚙️ jishu/ 技术（424 束）：AI·文档工程·构建·通信·容器·数据·物联网等 17 生态分组"]
    meta -->|"规范约束"| jishu
...
### ⚙️ [技术](jishu/index.md) · 424 束 · 17 组

| 分组                                               | 束数  | 说明                                                                                                         |
| ------------------------------------------------ | --- | ---------------------------------------------------------------------------------------------------------- |
| [🤖 人工智能与大模型（ai）](jishu/ai/index.md)             | 205 | agnes-ai · ai-agent · langchain-ai · datawhale · coze · deepseek · trae · tencent · pocketflow · anthropic · mobile-use · tiktoken · ai-security · agent-industry-research · domestic-model-token-export 及工程方法论等直挂束 |
