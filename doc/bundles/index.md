...
>
> 当前共 **378 个知识包**，按学科逻辑分为 **9 个学科域、43 个分组**（8 个学科域 + 1 个规范锚点）。
...
flowchart TD
    ...
    guoxue["📜 guoxue/ 国学（45 束）：儒道释法墨易·河洛·阳明心学·算学"]
    zhexue["💭 zhexue/ 哲学（4 束）：Ψhē 自指递归理论体系"]
    kexue["🔬 kexue/ 科学（10 束）：化学·物理学中西元典·西方数学经典"]
    wenxue["✒️ wenxue/ 文学（1 束）：中国古典文学经典"]
    yixue["🌿 yixue/ 医学与养生（10 束）：中医经典·黄帝内经·道医·养生·房中"]
    sheke["👥 sheke/ 社会科学（14 束）：职场管理·亲密关系·性学经典"]
    yishu["🎤 yishu/ 艺术（1 束）：声乐教学（美通唱法·咽音体系）"]
    jishu["⚙️ jishu/ 技术（292 束）：AI·文档工程·构建·通信·容器·数据·可视化等 12 生态分组"]
    meta -->|"规范约束"| jishu
...
| [📜 老子（Laozi）](guoxue/laozi/index.md) | 2 | 《老子》（《道德经》）——帛书《老子》阅读教程、老子著作原文与解读（出土文献基准、历代注本三线并收） |
...
### 🔬 [科学](kexue/index.md) · 10 束 · 3 组

| 分组 | 束数 | 说明 |
|------|------|------|
| [⚗️ 化学经典](kexue/chemistry/index.md) | 7 | 中西化学经典双线索——西方（波义耳、拉瓦锡、道尔顿、门捷列夫）与中国（参同契、抱朴子、天工开物） |
| [🔭 物理学经典](kexue/physics/index.md) | 2 | 中西物理学经典双线索——西方（伽利略至朗道 12 部元典）与中国（墨经、考工记、梦溪笔谈等九部典籍） |
| [📐 数学（Math）](kexue/math/index.md) | 1 | 国外数学经典阅读——欧美数学原著原文与解读教程（欧几里得到布尔巴基，五时段经典谱系） |

### ✒️ [文学](wenxue/index.md) · 1 束 · 1 组
...
### 🎤 [艺术](yishu/index.md) · 1 束 · 1 组

| 分组 | 束数 | 说明 |
|------|------|------|
| [🎤 声乐教学（Vocal）](yishu/vocal/index.md) | 1 | 美通唱法与咽音体系——林俊卿咽音练声八步骤、嗓音科学、常见毛病纠正与每日练声清单 |

### ⚙️ [技术](jishu/index.md) · 292 束 · 12 组

| 分组 | 束数 | 说明 |
|------|------|------|
| [🤖 人工智能与大模型（ai）](jishu/ai/index.md) | 121 | agnes-ai · ai-agent · langchain-ai · datawhale · coze · deepseek · trae · tencent · pocketflow · anthropic |
...
| [🧠 机器学习（ml）](jishu/ml/index.md) | 8 | ONNX 标准/转换器/编译器/推理后端 |
| [📊 数据科学（data）](jishu/data/index.md) | 7 | PyData 科学计算全栈——NumPy/pandas/matplotlib/Plotly/Dash/PyTables/SymPy |
