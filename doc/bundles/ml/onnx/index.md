...
title: "ONNX 机器学习生态"
okf_version: "0.2"
description: "ONNX（开放神经网络交换格式）生态系统源码级中文教程——8个核心知识束、109篇内容文档（含60概念+21示例+28信源），覆盖标准规范、IR、优化器、模型转换器、编译器与推理后端"
total_bundles: 8
...
所有知识束遵循 [OKF v0.2 规范](../../meta/okf-spec/index.md)，通过源码深度阅读（R→I→E→V→C 五阶段链路）生成，所有API引用均经Grep级源码验证。
