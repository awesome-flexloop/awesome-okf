...
type: Concept
title: 七、参考资料与扩展阅读
description: 术语表、权威参考资料、扩展阅读建议与进阶学习路径
...
sources:
  - id: learning-source
    resource: SpecWeave docs/knowledge/learning/01-agent-protocols-interfaces/interface-api-abi-protocol-wiki/06-resources.md
