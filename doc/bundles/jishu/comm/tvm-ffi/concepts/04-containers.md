...
description: 04 - 容器类型：Array、Map、Dict、List、Tuple、Shape、Variant
...
sources:
  - id: learning-source
    resource: SpecWeave docs/knowledge/learning/01-agent-protocols-interfaces/tvm-ffi-wiki/04-containers.md
    title: "spec:create-tvm-ffi-wiki-tutorial"
---
