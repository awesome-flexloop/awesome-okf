...
description: 02 - C++ 核心 API：Any、Object、Function、Tensor
...
sources:
  - id: learning-source
    resource: SpecWeave docs/knowledge/learning/01-agent-protocols-interfaces/tvm-ffi-wiki/02-cpp-core-api.md
