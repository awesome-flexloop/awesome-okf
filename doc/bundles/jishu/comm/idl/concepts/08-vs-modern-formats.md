...
description: 传统 IDL 与现代接口描述格式（OpenAPI/GraphQL Schema/JSON Schema/AsyncAPI）的边界划分、对比与演进，含 MDI 关联
...
sources:
  - id: learning-source
    resource: SpecWeave docs/knowledge/learning/01-agent-protocols-interfaces/idl-wiki/08-vs-modern-formats.md
    title: "spec:create-idl-wiki-tutorial"
---
