...
description: "Mermaid 流程图（Flowchart）完整指南：flowchart/graph 关键字与方向声明、十余种节点形状语法、特殊字符注意事项、九种连线类型、subgraph 分组与方向、classDef 样式与 default 类、clic"
tags: [mermaid, diagram, flowchart, graph, markup, visualization]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/mermaid-wiki/02-flowchart.md"
