...
description: "Mermaid 命令速查表：覆盖全部 17 种图表类型（flowchart/sequenceDiagram/classDiagram/stateDiagram-v2/erDiagram/gantt/pie/journey/timeline/"
tags: [mermaid, cheatsheet, 速查, flowchart, sequenceDiagram, classDiagram, stateDiagram, erDiagram, gantt, pie, journey, timeline]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/mermaid-wiki/10-cheatsheet.md"
