...
description: "Mermaid 集成与生态完整指南：mermaid-cli 命令行工具（@mermaid-js/mermaid-cli、mmdc、JSON 配置）、mermaid.live 在线编辑器、CDN/npm 集成与 SVG 渲染、Markdown"
tags: [mermaid, integration, mermaid-cli, mmdc, mermaid-live, cdn, npm, ecosystem, markup]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/mermaid-wiki/08-integrations-ecosystem.md"
