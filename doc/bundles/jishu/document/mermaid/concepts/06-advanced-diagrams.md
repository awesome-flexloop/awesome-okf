...
description: "Mermaid 六种进阶/专业图表完整指南：gitGraph Git 提交图（commit/branch/checkout/merge/cherry-pick）、requirementDiagram 需求图（requirement/elem"
tags: [mermaid, diagram, gitGraph, requirementDiagram, mindmap, block, c4, zenuml, markup, visualization]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/mermaid-wiki/06-advanced-diagrams.md"
