...
description: "Mermaid 常见问题与最佳实践：12 个高频渲染问题的现象/原因/解决方案（end 关键字、o/x 开头节点、pie 负值、中文乱码与引号、空行中断、subgraph 中文 ID、\n 换行、版本差异、securityLevel、elk"
tags: [mermaid, faq, troubleshooting, best-practices, 安全编码, check-mermaid, markup]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/mermaid-wiki/09-faq-best-practices.md"
