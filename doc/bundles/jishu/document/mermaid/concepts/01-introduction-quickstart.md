...
description: "本章介绍 Mermaid 的核心概念（文本即图表、解决 Doc-Rot）、工作原理（JavaScript 将文本渲染为 SVG，依赖 d3 与 dagre-d3），并通过 mermaid.live 在线编辑器完成快速上手，最后概览本地集成（"
tags: [mermaid, quickstart, 入门, doc-rot, mermaid.live, cdn, npm, svg, tutorial]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/mermaid-wiki/01-introduction-quickstart.md"
