...
description: "Mermaid 六种可视化图表完整指南：gantt 甘特图（dateFormat/section/任务元数据/时长单位/excludes）、pie 饼图（showData/donutHole/legendPosition）、journey "
tags: [mermaid, diagram, gantt, pie, journey, timeline, sankey, quadrantChart, markup, visualization]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/mermaid-wiki/05-aggregate-diagrams.md"
