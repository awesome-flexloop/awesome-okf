...
description: "Mermaid 各图表类型引号使用规则速查：16类图表引号矩阵、7条快速判断口诀、Top 5反模式、4步验证方法。解决Mermaid文档中最常见的引号误用问题（约70%语法错误源于引号）。"
tags: [mermaid, checklist, quote-rules, syntax, best-practices, troubleshooting]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/mermaid-wiki/mermaid-quote-rules-checklist.md"
