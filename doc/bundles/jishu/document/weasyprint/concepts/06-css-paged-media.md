...
type: "Wiki Tutorial"
title: "CSS 分页与打印特性"
description: "WeasyPrint CSS分页媒体特性：@page规则、16个边距盒位置、分页控制、交叉引用、计数器、脚注，含完整CSS代码示例"
tags: [weasyprint, css, paged-media, @page, pagination]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/weasyprint-wiki/06-css-paged-media.md"
