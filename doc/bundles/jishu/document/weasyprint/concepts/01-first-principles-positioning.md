...
type: "Wiki Tutorial"
title: "第一性原理与核心定位"
description: "PDF生成本质矛盾分析、现有5大方案痛点、WeasyPrint一句话定位、关键数据、核心特性矩阵、不支持的特性说明"
tags: [weasyprint, first-principles, positioning]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/weasyprint-wiki/01-first-principles-positioning.md"
