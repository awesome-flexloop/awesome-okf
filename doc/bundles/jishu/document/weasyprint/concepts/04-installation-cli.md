...
type: "Wiki Tutorial"
title: "安装与配置指南"
description: "WeasyPrint安装指南：Linux/macOS/Windows多平台方案对比、pip安装、验证方法、命令行完整用法、故障排查"
tags: [weasyprint, installation, cli, setup, windows, gtk]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/weasyprint-wiki/04-installation-cli.md"
