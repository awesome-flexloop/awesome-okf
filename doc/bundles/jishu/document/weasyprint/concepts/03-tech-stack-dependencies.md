...
type: "Wiki Tutorial"
title: "核心依赖与技术栈"
description: "WeasyPrint核心依赖解析：8个Python包依赖、3个系统C库、垂直工具链策略、依赖架构图"
tags: [weasyprint, dependencies, tech-stack, cffi, cairo, pango]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/weasyprint-wiki/03-tech-stack-dependencies.md"
