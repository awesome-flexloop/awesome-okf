...
description: "Pandoc+WeasyPrint/MyST+WeasyPrint Markdown转PDF完整工作流实战，含Windows最简安装、CSS分页模板、Mermaid处理、封面页、Python构建脚本"
tags: [weasyprint, pandoc, myst, markdown, workflow, best-practice, integration]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/weasyprint-wiki/14-markdown-workflows.md"
