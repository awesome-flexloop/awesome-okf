...
type: "Wiki Tutorial"
title: "十、局限性与最佳实践"
description: "WeasyPrint 5大核心局限性详解、10条生产级最佳实践（含CSS和Python代码示例）"
tags: [weasyprint, limitations, best-practices, production]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/weasyprint-wiki/10-limitations-best-practices.md"
