...
description: "WeasyPrint Python API完全指南：5个核心类、多种输入源（文件/URL/字符串/文件对象）、自定义CSS、渲染选项详解、分步渲染、自定义URL获取器、PDF finisher后处理钩子"
tags: [weasyprint, python-api, programming, code-examples]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/weasyprint-wiki/05-python-api-guide.md"
