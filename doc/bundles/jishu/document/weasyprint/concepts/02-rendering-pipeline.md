...
type: "Wiki Tutorial"
title: "架构深度解析：六步渲染管线"
description: "WeasyPrint六步渲染管线深度解析：HTML解析→CSS解析→CSS应用→盒树构建→多遍布局→绘制输出，含各阶段源码入口和关键设计说明"
tags: [weasyprint, architecture, pipeline, rendering]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/weasyprint-wiki/02-rendering-pipeline.md"
