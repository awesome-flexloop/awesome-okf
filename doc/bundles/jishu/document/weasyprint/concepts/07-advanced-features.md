...
type: "Wiki Tutorial"
title: "高级功能详解"
description: "WeasyPrint高级功能：PDF/A/UA/X变体配置、图片缓存、自定义字体配置、SVG支持、CMYK色彩管理"
tags: [weasyprint, pdf-variants, caching, fonts, svg, cmyk]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/weasyprint-wiki/07-advanced-features.md"
