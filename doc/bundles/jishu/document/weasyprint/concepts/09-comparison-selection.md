...
type: "Wiki Tutorial"
title: "九、方案对比与选型指南"
description: "WeasyPrint与Pandoc/MyST/Puppeteer/Playwright/wkhtmltopdf/PrinceXML多维度对比、分层工具链定位、选型决策树"
tags: [weasyprint, comparison, pandoc, myst, puppeteer, playwright, wkhtmltopdf, princexml, selection]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/weasyprint-wiki/09-comparison-selection.md"
