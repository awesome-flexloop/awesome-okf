...
description: "本文档汇总了 MyST Markdown 在日常使用中的最佳实践，结合官方文档推荐和实际项目经验，帮助你写出清晰、可维护、兼容性好的 MyST 文档"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/executablebooks-myst-guide/05-best-practices.md"
