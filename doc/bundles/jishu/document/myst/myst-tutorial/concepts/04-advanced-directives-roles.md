...
description: "Directives（指令）和 Roles（角色）是 MyST 扩展 Markdown 表达能力的两大核心机制。理解这两个概念是掌握 MyST 的关键"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/myst-markdown-tutorial/04-advanced-directives-roles.md"
