...
description: "本章通过学术论文写作案例，展示 MyST 在科研写作中的完整能力：数学公式、参考文献、交叉引用、多格式导出。配套模板见 examples/paper-template.md(examples/paper-template.md)"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/myst-markdown-tutorial/15-case-study-academic.md"
