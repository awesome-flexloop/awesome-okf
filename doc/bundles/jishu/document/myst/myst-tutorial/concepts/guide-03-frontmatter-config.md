...
description: "本文档详细介绍 MyST Markdown 的 Frontmatter（元数据）配置，包括页面级和项目级元数据的字段说明、作用范围、常用配置和完整示例"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/executablebooks-myst-guide/03-frontmatter-config.md"
