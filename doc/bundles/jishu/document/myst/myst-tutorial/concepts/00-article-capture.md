...
description: "本文档已按单一职责原则原子化为7个独立章节文件，存放于 executablebooks-myst-guide/(executablebooks-myst-guide/README.md) 目录："
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/executablebooks-myst-guide-wiki.md"
