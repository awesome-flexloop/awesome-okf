...
description: "注释用于编写过程中记录备注，脚注用于补充说明不打断正文的内容，参考文献用于学术写作中的引用管理"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/myst-markdown-tutorial/07-advanced-notes-citations.md"
