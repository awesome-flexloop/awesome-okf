...
description: "ExecutableBooks 是一个国际性的开源协作项目，旨在构建使用 Jupyter 生态系统发布计算性叙事文档（computational narratives）的开源工具"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/executablebooks-myst-guide/00-overview.md"
