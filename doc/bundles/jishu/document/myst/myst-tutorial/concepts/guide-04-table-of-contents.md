...
type: "Wiki Tutorial"
title: "目录结构（TOC）配置指南"
description: "本文档详细介绍 MyST Markdown 项目的目录结构（Table of Contents，TOC）配置，包括 TOC 概述、节点类型、嵌套结构、Glob 模式匹配、标题配置、隐藏页面、页面内 TOC 指令、URL Slug 规则、隐式"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/executablebooks-myst-guide/04-table-of-contents.md"
