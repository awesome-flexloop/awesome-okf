...
description: "除了提示框之外，MyST 还提供了丰富的 UI 交互组件，让技术文档具备类似网页应用的交互体验。本章介绍三种最常用的组件：卡片（Card）、下拉/折叠面板（Dropdown）和标签页（Tab/TabSet）"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/myst-markdown-tutorial/09-components-ui.md"
