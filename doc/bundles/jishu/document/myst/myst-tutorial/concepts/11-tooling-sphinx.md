...
description: "本章深入介绍 Sphinx + myst-parser 工具链的完整配置。第0章快速上手(00-quick-start.md) 提供了极简配置，本章覆盖生产环境所需的完整配置、常用扩展与排错指南"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/myst-markdown-tutorial/11-tooling-sphinx.md"
