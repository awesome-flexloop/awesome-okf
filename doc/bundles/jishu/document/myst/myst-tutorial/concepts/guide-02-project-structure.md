...
description: "本文档介绍 MyST 项目的标准目录结构、myst.yml 配置文件详解以及常用命令，帮助你快速搭建和管理 MyST 项目"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/executablebooks-myst-guide/02-project-structure.md"
