...
type: "Wiki Tutorial"
title: "示例：图片与表格"
description: "本文件展示图片（Image）、图（Figure）和各类表格的实际渲染效果"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/myst-markdown-tutorial/examples/figures-tables-demo.md"
