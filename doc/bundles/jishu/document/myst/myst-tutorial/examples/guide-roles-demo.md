...
description: "Roles 用于在行内插入特殊内容，是 MyST 区别于普通 Markdown 的核心特性之一。与 Directives（块级扩展）不同，Roles 不会产生新的块级元素，而是嵌入在文本行内"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/executablebooks-myst-guide/examples/roles-demo.md"
