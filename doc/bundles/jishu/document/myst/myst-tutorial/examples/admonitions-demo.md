...
description: "本文件展示 MyST 所有内置提示框样式的实际渲染效果，可直接复制使用"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/myst-markdown-tutorial/examples/admonitions-demo.md"
