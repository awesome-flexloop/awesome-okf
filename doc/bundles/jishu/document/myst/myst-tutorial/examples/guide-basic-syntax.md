...
description: "本示例演示 MyST Markdown 常用的 Directives 用法，以及与标准 Markdown 的兼容性"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/executablebooks-myst-guide/examples/basic-syntax.md"
