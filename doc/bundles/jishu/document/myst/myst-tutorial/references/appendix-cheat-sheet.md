...
description: "本速查表按类别整理最常用的 MyST 语法，方便快速查阅。所有示例均可直接复制使用"
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/myst-markdown-tutorial/appendix/cheat-sheet.md"
