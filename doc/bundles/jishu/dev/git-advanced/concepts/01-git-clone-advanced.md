...
sources:
  - id: learning-source
    resource: SpecWeave docs/knowledge/learning/08-systems-infrastructure/git-advanced-wiki/01-git-clone-advanced.md
    title: "internal:git-clone-no-local-bare-explanation"
---
