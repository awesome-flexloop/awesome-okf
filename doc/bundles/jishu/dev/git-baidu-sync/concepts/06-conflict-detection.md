...
tags: [git, baidu-netdisk, sync, conflict-detection, data-safety]
generated: { by: "process:learning-bundles-migration", at: "2026-09-02T00:00:00Z" }
status: draft
stale_after: 2027-09-02
sources:
  - id: learning-source
    resource: SpecWeave docs/knowledge/learning/08-systems-infrastructure/git-baidu-sync/06-conflict-detection.md
    title: original
---
# Git 网盘同步冲突检测与处理
...
.\check-conflicts.ps1 -RepoName myproject -SyncRoot <同步盘>\git-sync
.\check-conflicts.ps1 -Path D:\git-sync\repos\myproject.git -Clean
.\check-conflicts.ps1 -All -SyncRoot <同步盘>\git-sync -AutoClean
```
