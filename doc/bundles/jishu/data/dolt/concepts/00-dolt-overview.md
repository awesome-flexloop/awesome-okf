...
> 本文档覆盖 Dolt 产品定位、核心功能、产品矩阵、开源协议与兼容生态。对应 F-006~F-029。
...
Dolt 兼容 MySQL 5.7 协议（F-013），主流数据库客户端工具可直接连接，无需额外配置：
...
*本文档基于博文事实（F-006~F-029）生成，P0 声明（F-007/F-011/F-013/F-014/F-024/F-026）已全部核验 ✅。*
