...
- **P0 候选**：8 项（F-007/F-011/F-013/F-014/F-024/F-026/F-042/F-043/F-045）
...
- **产出**：三层知识拆分定稿，落 `jishu/data/dolt/` 直挂束
...
#### E-1 信源先行
- 先写 `references/article-source.md`（F-001~F-070 双份登记，其中 F-061~F-070 为二轮补登）
...
| 2 | F 编号双份一致 | ✅ | facts.md 70 条 = article-source.md 70 条（F-001~F-070 唯一编号集合一致，含二轮补登 F-061~F-070） |
...
- 事实编号（F-001~F-070）贯穿所有文档，引用一致

**技术专家视角**（事实准确性与深度）：
- P0 声明 8 项核验覆盖率达 100%，其中 F-042/F-045 两处偏差已识别并纠正
