...
| 信源 | 说明 | 引用内容 |
|------|------|---------|
| [博文信源登记](article-source.md) | F-001~F-085 全部编号事实登记（博文 72 + 源码 13）、信源距离分布、核验覆盖说明 | 全部 concepts 文档 |
| [P0 权威核验报告](verification.md) | 9 项 P0 声明逐项核验结论 + 勘误四张清单 | 全部 concepts 文档 |

## 信源核验说明

- 全部事实编号引用 spec `facts.md`（F-001~F-085），无 facts 之外的事实；其中 F-073~F-085 为本地源码核验的源码事实
