...
description: "这是过去十年里，HTML 最值得关注的一次升级。不是新增一个标签，也不是补一个属性，而是 HTML 可能要开始接管一件原本属于 JavaScript 的事：页面局部更新"
tags: [html, declarative-partial-updates, streaming, partial-rendering, web-standards, chrome, declarative-shadow-dom, ssr]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/declarative-partial-updates-wiki.md"
