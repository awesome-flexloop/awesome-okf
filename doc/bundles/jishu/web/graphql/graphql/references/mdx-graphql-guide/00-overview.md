...
description: "理解可查询文档理念、MDX与GraphQL各自角色、技术栈选型理由、三层架构总览"
tags: [mdx, graphql, overview, concepts, architecture]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/mdx-graphql-guide/00-overview.md"
