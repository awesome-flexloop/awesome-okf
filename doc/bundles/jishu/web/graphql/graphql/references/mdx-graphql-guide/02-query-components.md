...
description: "深入文档元数据Schema设计、Query组件模式、Fragment复用、静态生成vs运行时查询、服务端组件中的GraphQL"
tags: [mdx, graphql, components, schema, patterns]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/mdx-graphql-guide/02-query-components.md"
