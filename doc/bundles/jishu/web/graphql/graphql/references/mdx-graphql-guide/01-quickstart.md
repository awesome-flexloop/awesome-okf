...
description: "从零开始：创建Next.js项目→配置MDX→定义GraphQL Schema→嵌入查询组件→运行验证，含完整可复制代码"
tags: [mdx, graphql, quickstart, nextjs, tutorial]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/04-docs-markup-tooling/mdx-graphql-guide/01-quickstart.md"
