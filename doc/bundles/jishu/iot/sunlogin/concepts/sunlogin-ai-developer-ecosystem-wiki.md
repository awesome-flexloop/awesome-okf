...
sources:
  - id: learning-source
    resource: SpecWeave docs/knowledge/learning/07-vendor-product-learning/sunlogin/sunlogin-ai-developer-ecosystem-wiki.md
    title: "https://activity.sunlogin.oray.com/mcp, https://activity.sunlogin.oray.com/cli, https://service.oray.com/question/50091.html, external: awesun-mcp 仓库（外部项目）, external: awesun-skill 仓库（外部项目）, external: awesun-ui-locator 仓库（外部项目）, external: awesun-usecase-skill-example 仓库（外部项目）"
---
