...
sources:
  - id: learning-source
    resource: SpecWeave docs/knowledge/learning/07-vendor-product-learning/sunlogin/sunlogin-offline-hardware-wiki/10-resources.md
    title: "../sunlogin-offline-hardware-wiki.md#参考资料与链接"
---
## 十一、参考资料与链接
