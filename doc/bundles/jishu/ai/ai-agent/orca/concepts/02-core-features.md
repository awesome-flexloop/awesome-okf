...
type: "Wiki Tutorial"
title: "八大核心功能详解"
description: "Orca 八大核心功能总览：移动 Companion、并行 Worktree、终端分屏、设计模式、GitHub&Linear 原生集成、SSH Worktree、注释 AI Diff、拖拽文件，每项含功能说明/操作流程/应用价值，并附附加功能速览。"
tags: ["orca", "agent-orchestration", "multi-agent"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/02-core-features.md"
