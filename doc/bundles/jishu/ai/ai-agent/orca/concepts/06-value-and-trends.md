...
type: "Wiki Tutorial"
title: "核心价值总结与行业趋势"
description: "Orca 核心价值总结与行业趋势：IDE 从代码编辑器向代理编排器演进的产品哲学、统一跟踪/并行隔离/结果择优三大核心价值、多 Agent 并行开发范式与 Git Worktree 一等公民趋势、自带 Agent 理念，以及与开篇定位的呼应"
tags: ["orca", "agent-orchestration", "multi-agent"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/06-value-and-trends.md"
