...
type: "Wiki Tutorial"
title: "FAQ 与术语表"
description: "Orca 常见问题解答（9 个覆盖开源协议/系统支持/Agent 支持/自带订阅/磁盘隔离/移动端/IDE 对比/中文本地化）+ 18 个核心术语一张表通俗解释，作为本教程速查手册。"
tags: ["orca", "agent-orchestration", "multi-agent"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/07-faq-glossary.md"
