...
description: 状态管理：生产级 Agent 的分水岭（Part 2）
generated: { by: process:learning-bundles-migration, at: 2026-09-02T00:00:00Z }
status: draft
stale_after: 2027-09-02
sources:
  - id: learning-source
    resource: SpecWeave docs/knowledge/learning/01-agent-protocols-interfaces/agent-runtime-protocol-wiki/03-state-management.md
