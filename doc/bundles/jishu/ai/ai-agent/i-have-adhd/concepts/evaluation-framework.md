...
type: "Wiki Tutorial"
title: "七、评估框架与质量保障"
description: "\"输出更适合 ADHD 用户\"是一个主观感受，但**产品迭代不能凭感觉**。如果没有科学的评估体系："
tags: ["i-have-adhd", "agent-skill"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/03-code-devtools/i-have-adhd-wiki/06-evaluation-framework.md"
