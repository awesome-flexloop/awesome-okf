...
type: "Wiki Tutorial"
title: "八、自定义开发与故障排查"
description: "官方默认规则是通用设计，但每个人的 ADHD 表现和工作习惯不同。i-have-adhd 设计为完全可定制："
tags: ["i-have-adhd", "agent-skill"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/03-code-devtools/i-have-adhd-wiki/07-customization-and-troubleshooting.md"
