...
type: "Wiki Tutorial"
title: "05 权限认证流程"
description: "Hermes 插件的安全机制：名称消毒、路径穿越防护、manifest_version 校验、环境变量密钥与 project 插件权限开启"
tags: ["hermes-agent", "integration"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-integration/05-auth-permission.md"
