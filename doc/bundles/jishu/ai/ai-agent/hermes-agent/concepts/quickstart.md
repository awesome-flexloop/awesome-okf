...
description: "从安装脚本到首次对话的完整命令流，覆盖 install.sh/install.ps1、hermes setup/model/tools、启动 TUI 与 hermes update"
tags: ["hermes-agent"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-wiki/02-quickstart.md"
