...
type: "Wiki Tutorial"
title: "07 常见问题及解决方案"
description: "覆盖 SpecWeave 接入 Hermes 过程中的常见问题：未发现、未启用、schema 不匹配、单实例限制、Windows 路径、name 冲突、未重启"
tags: ["hermes-agent", "integration"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-integration/07-troubleshooting.md"
