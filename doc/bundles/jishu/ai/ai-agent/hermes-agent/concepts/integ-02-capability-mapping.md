...
description: "盘点 SpecWeave 的 skills/commands/scripts/roles/AGENTS.md/knowledge/vendor 能力，并给出到 Hermes 各类插件能力的映射方案"
tags: ["hermes-agent", "integration"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-integration/02-capability-mapping.md"
