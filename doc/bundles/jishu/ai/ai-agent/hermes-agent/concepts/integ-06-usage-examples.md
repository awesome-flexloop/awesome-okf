...
type: "Wiki Tutorial"
title: "06 调用方式示例"
description: "覆盖 Hermes 插件生命周期命令、hermes-okf 记忆命令、会话内工具调用与 with_context 记忆召回的完整调用示例"
tags: ["hermes-agent", "integration"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-integration/06-usage-examples.md"
