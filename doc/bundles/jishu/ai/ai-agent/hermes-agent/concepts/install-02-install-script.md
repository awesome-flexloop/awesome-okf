...
description: "本章面向 Linux、macOS 与 WSL2 用户，详细说明如何使用官方 `install.sh` 脚本完成 Hermes Agent 的一键安装，包括命令参数、安装阶段、目录布局以及安装后的验证方法。所有内容均以项目源码中的 `scripts/install.sh`、`setup-hermes.sh` 与 `README.md` 为准。"
tags: ["hermes-agent", "installation"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-installation/02-install-script.md"
