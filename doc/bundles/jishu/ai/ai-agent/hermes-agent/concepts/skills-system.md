...
type: "Wiki Tutorial"
title: "07 技能系统"
description: "Hermes 以技能（skill）承载过程记忆：agent 从经验创建/改进 SKILL.md 形式的技能；内置 skills/ 与可选 optional-skills/ 分层，技能中心统一管理，curator 后台维护技能生命周期"
tags: ["hermes-agent"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-wiki/07-skills.md"
