...
type: "Wiki Tutorial"
title: "04 数据格式转换方法"
description: "把 SpecWeave 的 AGENTS.md 契约、知识库 markdown 转换为 Hermes 插件元数据与 OKF bundle 的具体方法"
tags: ["hermes-agent", "integration"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-integration/04-data-conversion.md"
