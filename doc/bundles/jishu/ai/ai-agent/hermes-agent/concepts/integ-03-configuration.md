...
type: "Wiki Tutorial"
title: "03 配置文件设置"
description: "配置 Hermes 以启用 SpecWeave 插件与 hermes-okf 记忆层：config.yaml 的 plugins/memory/context 字段、HERMES_HOME、project 级插件"
tags: ["hermes-agent", "integration"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-integration/03-configuration.md"
