...
type: "Wiki Tutorial"
title: "00 集成总览与两条路径"
description: "把 SpecWeave 整个工作区接入 Hermes Agent，使其能力可被正确识别、调用与执行；涉及 Hermes Agent 框架插件路径与 Hermes OKF 记忆层两条路径"
tags: ["hermes-agent", "integration"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-integration/00-overview.md"
