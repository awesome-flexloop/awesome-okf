...
type: "Wiki Tutorial"
title: "11 术语表 / FAQ / 资源"
description: "术语速查（Hermes、prompt caching、toolset、memory provider、skill、plugin、context engine、gateway、delegation、honcho 等）、FAQ 与官方资源导航"
tags: ["hermes-agent"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-wiki/11-glossary-faq-resources.md"
