...
description: "本章列出安装 Hermes Agent 前必须满足的操作系统、硬件、系统依赖与运行时版本要求。所有信息均以项目源码中的 `pyproject.toml`、安装脚本、`Dockerfile`、`package.json` 及官方平台支持文档为准。"
tags: ["hermes-agent", "installation"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-installation/01-environment.md"
