...
description: "本章说明 Hermes Agent 安装完成后的完整验证流程，包括版本检查、环境诊断、状态查看、基础对话测试、工具功能验证、TUI 界面验证、浏览器工具验证、网关验证，以及日志位置与查看方法。建议按照本章顺序逐项验证，确保安装完整可用。"
tags: ["hermes-agent", "installation"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/hermes-agent-installation/07-verification.md"
