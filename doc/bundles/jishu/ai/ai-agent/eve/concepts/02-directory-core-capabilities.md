...
type: "Wiki Tutorial"
title: "目录结构与核心能力"
description: "Eve 目录结构详解：agent.ts 模型/运行时配置（defineAgent）、instructions.md 指令、tools 工具、skills 技能、sandbox 沙箱（四后端）、lib/connections/evals 补充。"
tags: ["eve", "agent-framework", "vercel"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/02-directory-core-capabilities.md"
