...
description: "Eve 进阶能力详解：subagents（子 Agent 委派、defineDynamic 条件可用、隔离边界）、schedules（defineSchedule、markdown/run 两种形式）、多 Agent 协作实战模式。"
tags: ["eve", "agent-framework", "vercel"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/04-advanced-capabilities.md"
