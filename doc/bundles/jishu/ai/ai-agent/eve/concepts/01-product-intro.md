...
type: "Wiki Tutorial"
title: "产品介绍与核心概念"
description: "Eve 产品定位（Next.js for Agents）、与 AI SDK/Agent Loop 的层次区分、以及'一个 Agent 就是一个目录'（filesystem-first）设计哲学。"
tags: ["eve", "agent-framework", "vercel"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/01-product-intro.md"
