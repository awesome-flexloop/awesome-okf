---
type: Concept
title: 脚本使用指南：一次性命令、自包含脚本与面向智能体的设计
description: 从官方教程补充的脚本工程实践——uvx/npx 等一次性命令的版本固定约定、PEP 723/Deno/Bun/Ruby 四种自包含脚本模式、面向智能体的脚本设计六原则（非交互、--help、错误消息、结构化输出、幂等、退出码）。
tags: [agent-skills, scripts, pep723, deno, bun, agent-friendly-design, specification]
generated: { by: "process:learning-migration merge", at: "2026-09-02" }
verified: { by: "process:seven-concepts-v", at: "2026-09-02" }
status: stable
stale_after: 2027-09-02
sources:
  - id: learning-scripts-guide
    resource: "SpecWeave docs/knowledge/learning/01-agent-protocols-interfaces/agent-skills-wiki/06-scripts-guide.md"
    title: Agent Skills 开放标准指南·脚本使用指南（agentskills.io 官方教程转译）
  - id: spec-mdx
    resource: /references/spec-sources.md
    title: docs/specification.mdx 权威格式规范
---

# 脚本使用指南：一次性命令、自包含脚本与面向智能体的设计
...
- [/concepts/00-skill-anatomy.md](/concepts/00-skill-anatomy.md) —— scripts/ 目录在技能解剖中的位置与文件引用约定
- [/concepts/03-authoring-principles.md](/concepts/03-authoring-principles.md) —— 脚本之外 SKILL.md 正文的设计原则
- [/references/quick-reference.md](/references/quick-reference.md) —— 脚本设计与 SKILL.md 模板速查
