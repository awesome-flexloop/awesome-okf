...
type: Reference
title: 博文信源事实清单
description: 腾讯技术工程博文《我用腾讯 Kuikly，把 DeepSeek Harness 装进了口袋》F-001~F-045 完整事实登记，含项目定位、Kuikly 跨端选型、DSH Host 协议直连、断线重连、连接方式、快速上手与扩展开发
tags: [事实清单, 信源, DeepSeek Harness, DSH, Kuikly, DSH Mobile, 跨端开发, Kotlin Multiplatform]
...
> 主信源：腾讯技术工程公众号（腾讯技术工程），2026-09-08 17:57 发布，作者腾讯程序员 yuki。
> URL：https://mp.weixin.qq.com/s/THtcdws01AV_Q3fe2pYRlQ
>
> F-001~F-045 共 45 条（与 spec facts.md 双份登记一致）。P0 核验 14 项：11✅ / 2⚠️ / 0❌。
> 作者为 DSH Mobile 与 dsh-scan-remote 的实际开发者（一手实测信源），同时属腾讯官方公众号发布。
...
- 2 ⚠️：A3 KuiklyWebview 版本（博文 1.0.1-2.0.21 vs 当前 README 1.0.2-2.0.21）、B3 "52 个方法/rpc-map.ts" 仅博文单源
- 0 ❌：无源文硬错误
