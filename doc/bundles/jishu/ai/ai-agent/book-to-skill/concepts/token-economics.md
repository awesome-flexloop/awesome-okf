...
description: "book-to-skill 的核心价值主张之一是 **24×-51× 的 token 节省**。这不是营销口号——有专门的测量工具和数学解释。"
tags: ["book-to-skill", "skill-compiler"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/02-prompt-coding/book-to-skill-wiki/04-token-economics.md"
