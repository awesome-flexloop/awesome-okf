...
description: "book-to-skill 提供两种安装方式：作为 Agent Skill 集成到 AI 助手环境中，或作为独立 CLI 工具直接使用。本章详细介绍安装流程、依赖管理、环境预检和基本使用方法。"
tags: ["book-to-skill", "skill-compiler"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/02-prompt-coding/book-to-skill-wiki/06-installation-usage.md"
