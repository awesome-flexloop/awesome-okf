...
description: "本章介绍如何扩展 book-to-skill 的功能，包括新增格式支持、修改生成行为、使用开发工具，以及理解优雅降级的设计原则。"
tags: ["book-to-skill", "skill-compiler"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/02-prompt-coding/book-to-skill-wiki/07-extending-development.md"
