...
description: "SKILL.md 是 book-to-skill 的灵魂——它是一份 600+ 行的**可执行规范**，Agent 读取后会严格按照其中定义的步骤生成 Skill。"
tags: ["book-to-skill", "skill-compiler"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/02-prompt-coding/book-to-skill-wiki/03-skill-md-spec.md"
