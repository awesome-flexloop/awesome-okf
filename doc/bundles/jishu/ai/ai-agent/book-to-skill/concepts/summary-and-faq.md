...
description: "1. **双层架构设计**：book-to-skill 采用 Python 确定性提取器 + SKILL.md 规范驱动生成器的双层架构，提取层负责格式解析和文本清理，生成层由 Agent 按可执行规范完成结构化提炼。"
tags: ["book-to-skill", "skill-compiler"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/02-prompt-coding/book-to-skill-wiki/09-summary-faq.md"
