...
description: "这些模式可以从 book-to-skill 迁移到 SpecWeave 和其他 Agent 工具项目。"
tags: ["book-to-skill", "skill-compiler"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/02-prompt-coding/book-to-skill-wiki/08-transferable-patterns.md"
