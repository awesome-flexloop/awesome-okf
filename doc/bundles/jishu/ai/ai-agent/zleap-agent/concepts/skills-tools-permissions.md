...
type: "Wiki Tutorial"
title: "Skill 与工具权限"
description: "Zleap-Agent Skill 机制与工具权限：SKILL.md 入口、SkillRegistry、敏感性审计、token 预算、调用策略、信任状态；request_approval/full_access 权限模式；MCP Runtime 与 MCP Secrets。"
tags: ["zleap-agent"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/zleap-agent-wiki/04-skills-tools-permissions.md"
