...
type: "Wiki Tutorial"
title: "FAQ 与术语表"
description: "Zleap-Agent FAQ 与术语表：常见问题解答（适合用户、是否需要本地模型、与单一大 prompt 区别、Workspace 协作、飞书/微信接入、Skill 导入等）+ 核心术语通俗解释。"
tags: ["zleap-agent"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-agent-frameworks/zleap-agent-wiki/08-faq-glossary.md"
