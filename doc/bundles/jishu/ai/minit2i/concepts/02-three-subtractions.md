...
description: "本章深入解析MiniT2I在技术路线上的三个激进减法决策，以及支撑每个决策的技术逻辑和实验证据。"
tags: ["minit2i", "text-to-image", "transformer", "diffusion", "pixel-space"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-ai-multimodal-content/minit2i-wiki/02-three-subtractions.md"
