...
description: "MM-JiT（Multi-Modal Joint Transformer）是MiniT2I提出的核心架构创新。它不是在现有MM-DiT架构上做增量改进，而是从第一性原理出发重新思考多模态条件注入的方式，最终回归到接近标准预归一化Tran…"
tags: ["minit2i", "text-to-image", "transformer", "diffusion", "pixel-space"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-ai-multimodal-content/minit2i-wiki/03-mm-jit-architecture.md"
