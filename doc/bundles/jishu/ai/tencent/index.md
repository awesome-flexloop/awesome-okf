...
本分组当前包含 6 个已生成知识包，共 38 个概念文档、12 个示例文档、27 个信源登记，基于 2026-08-23 的源码阅读、网页抓取与 2026-09-20 的博文核验生成，总计 445 条编号事实（原有 427 条 + WeKnora 18 条）。所有源码知识包均经过 Grep 级 API 真实性验证，博文转化束经过 P0/P1 权威核验。
