...
type: "Wiki Tutorial"
title: "四大核心场景"
description: "EchoBird 四大核心场景（安装修复 Agent / 一键本地大模型 / 我的 AI 项目 / 应用管理器）的功能说明、操作流程、源码实现要点与应用价值，以及由 Model Nexus 串联的顺滑使用流程"
tags: ["echobird", "ai-agent", "desktop-tool", "tauri"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/04-core-scenarios.md"
