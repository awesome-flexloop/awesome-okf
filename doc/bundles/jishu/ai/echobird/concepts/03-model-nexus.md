...
description: "Model Nexus 模型中心的数据模型（modelDirectory.json 的 providers/relays 结构）、API Key AES-256-GCM 加密、配置一次到处可用的实现机制、官方端点恢复"
tags: ["echobird", "ai-agent", "desktop-tool", "tauri"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/03-model-nexus.md"
