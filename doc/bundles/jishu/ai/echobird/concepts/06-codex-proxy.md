...
description: "EchoBird Codex Proxy 的协议转换能力：127.0.0.1:53682 本地服务绑定、Responses↔Chat 双向转换、SSE 流式处理、多厂商适配（GLM/MiMo/Qwen）、配置管理与会话追踪、Codex 二进制解析与工程价值"
tags: ["echobird", "ai-agent", "desktop-tool", "tauri"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/06-codex-proxy.md"
