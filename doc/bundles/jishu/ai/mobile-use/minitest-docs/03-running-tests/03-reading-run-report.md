...
type: "Wiki Tutorial"
title: "阅读运行报告"
description: "详细介绍运行报告的结构，包括判定结果、验收标准列表、视频时间线、修复提示，以及无法处理状态的排查方法。"
tags: ["minitest", "mobile-testing", "ai-qa"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-mobile-testing/minitest-mobile-use-wiki/minitest-docs/03-running-tests/03-reading-run-report.md"
