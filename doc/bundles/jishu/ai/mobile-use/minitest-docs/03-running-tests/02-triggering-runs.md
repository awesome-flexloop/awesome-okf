...
type: "Wiki Tutorial"
title: "触发运行"
description: "介绍从仪表板、Slack、GitHub Actions、CLI四种方式触发测试运行的方法。"
tags: ["minitest", "mobile-testing", "ai-qa"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-mobile-testing/minitest-mobile-use-wiki/minitest-docs/03-running-tests/02-triggering-runs.md"
