...
type: "Wiki Tutorial"
title: "快速开始"
description: "从注册到运行第一个用户故事的完整快速开始教程，全程约15分钟。"
tags: ["minitest", "mobile-testing", "ai-qa"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-mobile-testing/minitest-mobile-use-wiki/minitest-docs/01-getting-started/03-quickstart.md"
