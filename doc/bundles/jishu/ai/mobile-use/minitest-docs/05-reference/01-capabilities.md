...
type: "Wiki Tutorial"
title: "能力范围"
description: "诚实回答\\\"这对我的应用有效吗？\\\" — 详细说明Mini能做什么、即将推出什么、目前不能做什么以及不在路线图上的功能。"
tags: ["minitest", "mobile-testing", "ai-qa"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-mobile-testing/minitest-mobile-use-wiki/minitest-docs/05-reference/01-capabilities.md"
