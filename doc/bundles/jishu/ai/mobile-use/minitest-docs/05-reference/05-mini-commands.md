...
type: "Wiki Tutorial"
title: "Mini命令参考"
description: "Slack中@Mini支持的所有命令，包括运行命令、编写命令、应用命令及其替代措辞。"
tags: ["minitest", "mobile-testing", "ai-qa"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-mobile-testing/minitest-mobile-use-wiki/minitest-docs/05-reference/05-mini-commands.md"
