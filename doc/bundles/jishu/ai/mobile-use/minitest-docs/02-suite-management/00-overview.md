...
type: "Wiki Tutorial"
title: "测试套件管理总览"
description: "测试套件管理章节导航，包含用户故事结构、手动编写方法和Mini自动维护机制。"
tags: ["minitest", "mobile-testing", "ai-qa"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-mobile-testing/minitest-mobile-use-wiki/minitest-docs/02-suite-management/00-overview.md"
