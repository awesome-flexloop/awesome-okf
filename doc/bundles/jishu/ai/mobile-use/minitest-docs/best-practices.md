...
type: "Wiki Tutorial"
title: "最佳实践"
description: "从官方文档中提取的minitest产品使用和mobile-use SDK开发最佳实践，帮助用户高效使用工具并避免常见陷阱。"
tags: ["minitest", "mobile-testing", "ai-qa"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-mobile-testing/minitest-mobile-use-wiki/best-practices.md"
