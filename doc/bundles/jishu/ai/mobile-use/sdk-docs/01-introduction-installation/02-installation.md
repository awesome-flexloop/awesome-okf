...
type: "Wiki Tutorial"
title: "安装指南"
description: "Mobile Use SDK安装指南，包含系统要求、SDK安装和设备连接配置。"
tags: ["mobile-use", "minitap", "sdk"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-mobile-testing/minitest-mobile-use-wiki/mobile-use-sdk-docs/01-introduction-installation/02-installation.md"
