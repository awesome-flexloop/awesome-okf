...
type: "Wiki Tutorial"
title: "Agent 类"
description: "Agent 类是 mobile-use SDK 的主入口点，负责管理设备交互和执行任务。"
tags: ["mobile-use", "minitap", "sdk"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-mobile-testing/minitest-mobile-use-wiki/mobile-use-sdk-docs/05-sdk-reference/01-agent-class.md"
