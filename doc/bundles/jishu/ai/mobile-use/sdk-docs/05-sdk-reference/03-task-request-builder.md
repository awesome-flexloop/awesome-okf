...
description: "TaskRequestBuilder 类提供流式接口用于配置带详细选项的任务请求。"
tags: ["mobile-use", "minitap", "sdk"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-mobile-testing/minitest-mobile-use-wiki/mobile-use-sdk-docs/05-sdk-reference/03-task-request-builder.md"
