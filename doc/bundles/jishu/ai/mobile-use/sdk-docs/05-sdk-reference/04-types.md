...
type: "Wiki Tutorial"
title: "类型定义"
description: "mobile-use SDK 中使用的核心类型和数据结构参考。"
tags: ["mobile-use", "minitap", "sdk"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-mobile-testing/minitest-mobile-use-wiki/mobile-use-sdk-docs/05-sdk-reference/04-types.md"
