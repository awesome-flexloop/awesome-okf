...
description: "QuantDinger是一个**自托管的AI量化交易平台**，作者为brokermr810。它将AI研究、策略编写、回测、模拟盘、实盘执行、监控全链路整合进一个Docker Compose栈中，用户的代码、数据、密钥全部运行在自己的机器上。"
tags: ["quantdinger", "quant-trading", "ai-agent", "mcp"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/quantdinger-ai-trading-wiki.md"
