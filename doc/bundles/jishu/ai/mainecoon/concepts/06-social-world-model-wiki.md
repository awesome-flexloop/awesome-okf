...
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-ai-multimodal-content/mainecoon-wiki/06-social-world-model-wiki.md"
...
- 决策速查卡：[decision-summary.md](decision-summary.md)
- 批判性评论：[critical-review-draft.md](critical-review-draft.md)
- 方法论模式：三角困境→架构级解决框架（trilemma-architectural-resolution.md，SpecWeave 复盘模式库）
