...
type: "Wiki Tutorial"
title: "VeADK 智能体开发框架"
description: "VeADK（Volcengine Agent Development Kit）智能体开发框架详解：三语言 SDK 安装、与 Google ADK 兼容说明、VeADK Family 20+ 产品融合矩阵、DeepResearch 6 大构建特性、GitHub 开源仓库清单。"
tags: ["volcengine", "agentkit", "veadk", "domestic-platform"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/03-veadk-framework.md"
