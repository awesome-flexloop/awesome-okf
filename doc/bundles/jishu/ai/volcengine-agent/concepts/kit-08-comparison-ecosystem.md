...
type: "Wiki Tutorial"
title: "竞品对比与生态定位"
description: "AgentKit 与 Dify、LangGraph、Coze、千帆平台、钉钉生态等 6 大竞品在 12 个维度的横向对比表、生态位四象限定位、开源-商业双轨策略、VeADK 家族 20+ 产品生态矩阵与选型决策建议。"
tags: ["volcengine", "agentkit", "veadk", "domestic-platform"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/08-comparison-ecosystem.md"
