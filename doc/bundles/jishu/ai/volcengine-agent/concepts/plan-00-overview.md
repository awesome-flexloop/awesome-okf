...
description: "火山引擎方舟（Ark）分享倡议第一期优质开发者实践已收录于方舟开发者Cookbook，获得社区广泛关注与好评。第二期共创计划正式从语言模型单模态场景扩展到跨模态场景，覆盖语言+生图+生视频+向量化+Harness能力的全栈Agent开发实践。"
tags: ["volcengine", "agentkit", "veadk", "domestic-platform"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/00-overview.md"
