...
description: "AgentKit SDK & CLI 工具链详解：装饰器式 API 设计与完整代码示例、Local/Hybrid/Cloud 三种部署模式对比表、CLI 五连命令（init/config/build/deploy/launch）使用指南、Tool/Service 接入流程图、VeADK 与 AgentKit SDK 的关系图。"
tags: ["volcengine", "agentkit", "veadk", "domestic-platform"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/04-agentkit-sdk-cli.md"
