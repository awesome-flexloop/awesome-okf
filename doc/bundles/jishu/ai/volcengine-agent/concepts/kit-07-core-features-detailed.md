...
type: "Wiki Tutorial"
title: "核心功能深度解析"
description: "AgentKit 治理外环 5 大核心模块深度解析：Identity 鉴权模型、Gateway 双轨接入、A2A 多 Agent 协作、Observability 三维信号、Evaluation 评测三角与发布闸门。"
tags: ["volcengine", "agentkit", "veadk", "domestic-platform"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/07-core-features-detailed.md"
