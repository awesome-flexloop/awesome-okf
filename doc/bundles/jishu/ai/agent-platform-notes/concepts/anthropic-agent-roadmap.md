...
description: "深度解析Anthropic即将推出的六条Agent产品线：Conway永久在线智能体、文件级记忆系统、Orbit主动助手、Operon生命科研平台、BugCrawl代码Bug自动修复，以及生态升级细节和GPT-5.6竞争动态分析。"
tags: ["ai-agent", "platform-notes", "aggregation"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/anthropic-agent-roadmap-wiki.md"
