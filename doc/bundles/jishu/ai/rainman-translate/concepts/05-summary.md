...
type: "Wiki Tutorial"
title: "总结与回顾"
description: "1. **Rainman Translate Book 是一个基于 Claude Code Skill 的整书翻译开源项目**，由开发者 deusyu 创建，支持 PDF、DOCX、EPUB 输入，输出 HTML、DOCX、EPUB、PDF 五种格式。"
tags: ["rainman-translate", "translation", "ai-agent"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-summary.md"
