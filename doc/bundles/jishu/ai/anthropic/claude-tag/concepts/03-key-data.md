...
description: "Claude Tag 重要数据汇总：Anthropic 65%产品代码参与、Opus 4.8唯一支持、率先登陆Slack、30天内取代现有应用、Beta开放对象、扩展计划、Token预算管理等。"
tags: ["claude-tag", "anthropic", "enterprise-agent", "ambient-mode"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/03-key-data.md"
