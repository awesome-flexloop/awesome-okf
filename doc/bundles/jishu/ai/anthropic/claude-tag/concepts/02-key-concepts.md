...
description: "Claude Tag 关键术语解释：Claude Tag、Ambient Mode（主动介入模式）、共享上下文、持续记忆、异步执行、Claude身份权限隔离、Opus 4.8、Fable 5。"
tags: ["claude-tag", "anthropic", "enterprise-agent", "ambient-mode"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/02-key-concepts.md"
