...
description: "Claude Tag 五大核心观点：产品定位（Claude Code进化）、卡帕西LLM三次变革论断、与传统AI助手的根本差异、四大能力（共享上下文/持续记忆/主动介入/异步执行）、企业统一入口战略。"
tags: ["claude-tag", "anthropic", "enterprise-agent", "ambient-mode"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/01-core-insights.md"
