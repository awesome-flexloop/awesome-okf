...
type: Concept
title: "第2章：指标体系设计"
description: "系统阐述AI Agent评测指标体系设计，包括14大类指标分类、核心指标深度解析、AWS三层评估框架、指标计算方法与适用场景、指标选择指南。"
tags: [ai-engineering, learning, "agent-evaluation", "metrics", "pass-at-k", "rag-metrics", "agent-metrics", "efficiency", "safety", "aws-framework"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/05-evaluation/agent-evaluation-wiki/02-metrics-design.md"
    title: "第2章：指标体系设计"
---
# 第2章：指标体系设计
