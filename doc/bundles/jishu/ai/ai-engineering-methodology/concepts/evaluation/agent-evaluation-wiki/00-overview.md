...
description: "AI Agent 评测体系化建设方法论系统性教程，涵盖评测理论基础、指标体系设计、基准测试构建、自动化评测框架、人工评估方法论、评测数据治理、行业实践案例、工具链选型、持续评测体系与参考资源。"
tags: [ai-engineering, learning, "agent-evaluation", "evaluation-methodology", "benchmark", "metrics", "overview", "tutorial"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/05-evaluation/agent-evaluation-wiki/00-overview.md"
    title: "AI Agent 评测体系化建设方法论教程总览"
---
