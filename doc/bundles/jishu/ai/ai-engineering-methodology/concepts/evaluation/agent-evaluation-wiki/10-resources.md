...
type: Concept
title: "第10章：术语表与参考资源"
description: "AI Agent评测核心术语表、权威参考来源分类整理、按难度分级的扩展阅读建议、项目内相关wiki交叉引用，为持续深入学习提供索引。"
tags: [ai-engineering, learning, "agent-evaluation", "glossary", "references", "resources", "further-reading"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/05-evaluation/agent-evaluation-wiki/10-resources.md"
    title: "第10章：术语表与参考资源"
---
# 第10章：术语表与参考资源
