...
type: Concept
title: "第7章：行业实践案例"
description: "系统阐述AI Agent评测的行业实践案例，包括Coding Agent、RAG Agent、多工具Agent、多Agent协作、生产环境CI/CD五大案例，以及7个常见反模式警示。"
tags: [ai-engineering, learning, "agent-evaluation", "industry-practices", "coding-agent", "rag-agent", "multi-tool-agent", "multi-agent", "aws-motorway", "anti-patterns"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/05-evaluation/agent-evaluation-wiki/07-industry-practices.md"
    title: "第7章：行业实践案例"
---
# 第7章：行业实践案例
