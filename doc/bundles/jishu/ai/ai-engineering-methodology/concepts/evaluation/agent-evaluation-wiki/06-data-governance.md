...
type: Concept
title: "第6章：评测数据治理"
description: "系统阐述AI Agent评测数据治理方法，包括评测数据生命周期、数据采集策略、标注质量管理、版本管理、隐私保护、数据质量保障与数据集迭代策略。"
tags: [ai-engineering, learning, "agent-evaluation", "data-governance", "data-versioning", "dvc", "privacy", "pii", "data-quality", "gold-set"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/05-evaluation/agent-evaluation-wiki/06-data-governance.md"
    title: "第6章：评测数据治理"
---
# 第6章：评测数据治理
