...
type: Concept
title: "第1章：评测理论基础"
description: "系统阐述AI Agent评测的理论基础，包括标准定义、与传统LLM评测的本质区别、发展时间线、能力维度框架、评测范式演进、信效度理论、伦理考虑与核心挑战。"
tags: [ai-engineering, learning, "agent-evaluation", "evaluation-theory", "benchmark", "metrics", "reliability", "validity", "ethics", "timeline"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/05-evaluation/agent-evaluation-wiki/01-theory-foundations.md"
    title: "第1章：评测理论基础"
---
# 第1章：评测理论基础
