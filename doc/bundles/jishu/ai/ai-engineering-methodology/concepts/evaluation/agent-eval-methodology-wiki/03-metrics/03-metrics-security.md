...
description: "基于IETF提出的4层55项安全评估框架，详解输入/提示层、模型/推理层、工具/行动层、系统/治理层的安全指标架构与关键指标。"
tags: [ai-engineering, learning, "agent-evaluation", "metrics", "security", "ietf", "prompt-injection", "privacy", "compliance"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/05-evaluation/agent-eval-methodology-wiki/03-metrics/03-metrics-security.md"
    title: "模块3.6：安全维度指标详解"
---
# 模块3.6：安全维度指标详解
