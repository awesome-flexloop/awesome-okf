...
type: Concept
title: "模块2：核心评测框架对比"
description: "深度对比HELM、MT-Bench、AgentBench、AutoEval、τ-bench、AgentBoard六大评测框架，给出基于8个维度的横向对比表与选型决策树。"
tags: [ai-engineering, learning, "agent-evaluation", "framework", "helm", "mt-bench", "agentbench", "auto-eval", "tau-bench", "agentboard", "selection"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/05-evaluation/agent-eval-methodology-wiki/02-frameworks/02-core-frameworks.md"
    title: "模块2：核心评测框架对比"
---
# 模块2：核心评测框架对比
