...
tags: [ai-engineering, learning, "agent-evaluation", "glossary", "methodology"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/05-evaluation/agent-eval-methodology-wiki/glossary.md"
    title: "Agent评测方法论：核心术语表"
---
# Agent评测方法论：核心术语表
