...
type: Concept
title: "DeepTutor快速开始"
tags: [ai-engineering, learning, DeepTutor, 快速开始, 实践]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/03-methodology/seven-concepts-deeptutor-wiki/02-deeptutor-case/03-quick-start.md"
    title: "DeepTutor快速开始"
  - id: original-source
