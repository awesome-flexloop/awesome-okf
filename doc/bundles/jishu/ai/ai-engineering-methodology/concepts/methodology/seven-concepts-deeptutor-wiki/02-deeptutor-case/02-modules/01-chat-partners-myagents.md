...
tags: [ai-engineering, learning, DeepTutor, 模块, Chat, Partners]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/03-methodology/seven-concepts-deeptutor-wiki/02-deeptutor-case/02-modules/01-chat-partners-myagents.md"
    title: "Chat + Partners + My Agents 模块"
  - id: original-source
