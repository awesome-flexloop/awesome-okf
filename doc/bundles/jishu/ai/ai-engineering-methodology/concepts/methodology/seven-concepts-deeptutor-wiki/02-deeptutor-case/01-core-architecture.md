...
type: Concept
title: "DeepTutor核心架构"
tags: [ai-engineering, learning, DeepTutor, 架构, 案例]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/03-methodology/seven-concepts-deeptutor-wiki/02-deeptutor-case/01-core-architecture.md"
    title: "DeepTutor核心架构"
  - id: original-source
