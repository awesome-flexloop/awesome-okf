...
tags: [ai-engineering, learning, DeepTutor, 模块, Memory, Settings]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/03-methodology/seven-concepts-deeptutor-wiki/02-deeptutor-case/02-modules/04-memory-settings.md"
    title: "Memory + Settings 模块"
  - id: original-source
