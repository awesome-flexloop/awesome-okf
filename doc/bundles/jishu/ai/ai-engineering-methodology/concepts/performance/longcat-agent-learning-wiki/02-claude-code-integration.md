...
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/06-performance/longcat-agent-learning-wiki/02-claude-code-integration.md"
    title: "Claude Code接入LongCat-2.0配置指南"
  - id: original-source
    resource: https://mp.weixin.qq.com/s/ymt9W64FD5IwCDNeQFuheA
---
