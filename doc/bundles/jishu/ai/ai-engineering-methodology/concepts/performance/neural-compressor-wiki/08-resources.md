...
type: Concept
title: "术语表与资源"
description: "Intel Neural Compressor 相关术语表、官方文档链接、参考论文与学习资源。"
tags: [ai-engineering, learning, "neural-compressor", "glossary", "resources", "references"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/06-performance/neural-compressor-wiki/08-resources.md"
    title: "术语表与资源"
  - id: original-source
