...
type: Concept
title: "最佳实践"
description: "Intel Neural Compressor 量化流程最佳实践：校准数据选择、精度验证、性能调优与常见陷阱。"
tags: [ai-engineering, learning, "neural-compressor", "best-practices", "performance", "calibration"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/06-performance/neural-compressor-wiki/06-best-practices.md"
    title: "最佳实践"
  - id: original-source
