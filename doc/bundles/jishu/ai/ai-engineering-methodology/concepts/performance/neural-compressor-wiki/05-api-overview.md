...
type: Concept
title: "API 概览"
description: "Intel Neural Compressor PyTorch 扩展 API 的核心类与函数介绍，包括 prepare、convert、量化配置等关键接口。"
tags: [ai-engineering, learning, "neural-compressor", "api", "pytorch", "reference"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/06-performance/neural-compressor-wiki/05-api-overview.md"
    title: "API 概览"
  - id: original-source
