...
type: Concept
title: "常见问题"
description: "Intel Neural Compressor 使用过程中的常见问题与解决方案。"
tags: [ai-engineering, learning, "neural-compressor", "faq", "troubleshooting"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/06-performance/neural-compressor-wiki/07-faq.md"
    title: "常见问题"
  - id: original-source
