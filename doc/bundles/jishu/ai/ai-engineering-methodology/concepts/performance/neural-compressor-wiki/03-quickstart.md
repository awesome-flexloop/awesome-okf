...
type: Concept
title: "快速开始"
description: "Intel Neural Compressor 快速上手指南，包含完整的 PyTorch CPU 模型量化示例代码与详细注释。"
tags: [ai-engineering, learning, "neural-compressor", "quickstart", "code-example", "pytorch"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/06-performance/neural-compressor-wiki/03-quickstart.md"
    title: "快速开始"
  - id: original-source
