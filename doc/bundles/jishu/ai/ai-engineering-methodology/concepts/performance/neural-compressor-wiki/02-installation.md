...
type: Concept
title: "安装指南"
description: "Intel Neural Compressor PyTorch 后端的安装步骤、依赖说明与不同硬件环境的配置要点。"
tags: [ai-engineering, learning, "neural-compressor", "installation", "pytorch", "setup"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/06-performance/neural-compressor-wiki/02-installation.md"
    title: "安装指南"
  - id: original-source
    resource: https://intel.github.io/neural-compressor/latest/docs/source/installation_guide.html
---
# 安装指南
