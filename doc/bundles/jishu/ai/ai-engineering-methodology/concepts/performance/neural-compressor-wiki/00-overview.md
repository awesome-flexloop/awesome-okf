...
description: "Intel Neural Compressor 开源模型压缩库系统性中文教程，涵盖核心概念、安装指南、快速开始、量化技术、API 概览、最佳实践与常见问题。"
tags: [ai-engineering, learning, "neural-compressor", "model-compression", "quantization", "pytorch", "tutorial"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/06-performance/neural-compressor-wiki/00-overview.md"
    title: "Intel Neural Compressor 教程总览"
  - id: original-source
