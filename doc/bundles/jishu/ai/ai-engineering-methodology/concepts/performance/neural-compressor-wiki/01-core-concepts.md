...
type: Concept
title: "核心概念与架构"
description: "Intel Neural Compressor 的核心概念、模型压缩技术分类、架构设计与工作流程详解。"
tags: [ai-engineering, learning, "neural-compressor", "architecture", "core-concepts", "workflow"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/06-performance/neural-compressor-wiki/01-core-concepts.md"
    title: "核心概念与架构"
  - id: original-source
