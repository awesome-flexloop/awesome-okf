...
description: "学习分析卡兹克《Vibe Coding 两大神级 Prompt》一文：第一性原理(管生成)与对抗式审查(管验证)构成完整闭环,是 Vibe Coding 的两大基石。含本项目亲身践行验证案例（含反面教材）及元方法论自举验证。"
tags: [ai-engineering, learning, "vibe-coding", "prompt", "第一性原理", "对抗式审查", "ai-agent", "代码审查", "multi-agent", "aihot", "可复用模式", "践行鸿沟", "类比推理"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/02-prompt-coding/vibe-coding-prompts-learning-analysis.md"
    title: "Vibe Coding 两大神级 Prompt 学习分析"
---
