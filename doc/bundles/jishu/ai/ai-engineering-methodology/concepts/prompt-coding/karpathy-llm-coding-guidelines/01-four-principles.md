...
type: Concept
title: "四条核心原则详解"
description: "四条核心原则的详细说明：编码前先思考、简约至上、精确编辑、目标驱动，包含每条原则的问题根源、具体要求和检验标准。"
tags: [ai-engineering, learning, karpathy, llm, coding, agent, guidelines, principles, think-before-coding, simplicity, surgical-changes, goal-driven]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/02-prompt-coding/karpathy-llm-coding-guidelines/01-four-principles.md"
    title: "四条核心原则详解"
  - id: original-source
    resource: https://github.com/multica-ai/andrej-karpathy-skills/blob/main/CLAUDE.md
---
# 四条核心原则详解
