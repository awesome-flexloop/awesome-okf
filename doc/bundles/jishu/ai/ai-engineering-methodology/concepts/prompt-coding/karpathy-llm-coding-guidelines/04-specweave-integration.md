...
description: "Karpathy LLM编程准则在SpecWeave项目中的整合情况：四条原则如何融入现有规范体系，对应的规范文件位置，以及团队使用方式。"
tags: [ai-engineering, learning, karpathy, llm, coding, agent, guidelines, specweave, integration, rules]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/02-prompt-coding/karpathy-llm-coding-guidelines/04-specweave-integration.md"
    title: "SpecWeave 项目整合情况"
---
# SpecWeave 项目整合情况
