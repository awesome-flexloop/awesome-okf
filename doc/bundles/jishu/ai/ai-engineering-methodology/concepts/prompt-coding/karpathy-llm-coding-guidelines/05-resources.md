...
type: Concept
title: "资源与参考链接"
description: "相关资源链接：三个官方仓库（karpathy-skills/multica/multica-cli）的文件结构、分发格式说明、Karpathy原帖、中文报道、Multica平台相关资源等参考资料。"
tags: [ai-engineering, learning, karpathy, llm, coding, agent, guidelines, resources, references, repository-structure, multica, multica-cli]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/02-prompt-coding/karpathy-llm-coding-guidelines/05-resources.md"
    title: "资源与参考链接"
  - id: original-source
    resource: https://github.com/multica-ai/andrej-karpathy-skills + https://github.com/multica-ai/multica + https://github.com/multica-ai/multica-cli
---
# 资源与参考链接
