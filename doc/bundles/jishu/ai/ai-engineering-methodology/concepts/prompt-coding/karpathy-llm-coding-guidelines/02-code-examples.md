...
type: Concept
title: "真实代码正反例"
description: "真实世界代码示例演示四条原则，每个示例展示LLM常见错误做法和正确做法，涵盖隐藏假设、过度抽象、顺手重构、模糊目标等场景。"
tags: [ai-engineering, learning, karpathy, llm, coding, agent, guidelines, examples, python, anti-patterns]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/02-prompt-coding/karpathy-llm-coding-guidelines/02-code-examples.md"
    title: "真实代码正反例"
  - id: original-source
    resource: https://github.com/multica-ai/andrej-karpathy-skills/blob/main/EXAMPLES.md
---
# 真实代码正反例
