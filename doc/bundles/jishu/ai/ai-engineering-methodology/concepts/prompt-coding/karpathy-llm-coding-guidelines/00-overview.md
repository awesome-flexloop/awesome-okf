...
description: "源自Andrej Karpathy对LLM编程陷阱观察的四条行为准则，用一个CLAUDE.md文件管住AI编程最常犯的毛病。本教程包含背景介绍、核心原则详解、真实代码正反例、安装使用指南，以及在SpecWeave项目中的整合情况。"
tags: [ai-engineering, learning, karpathy, llm, coding, agent, guidelines, claude, ai-programming, agentic-engineering]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/02-prompt-coding/karpathy-llm-coding-guidelines/00-overview.md"
    title: "Karpathy LLM 编程准则：概述与背景"
  - id: original-source
    resource: https://www.36kr.com/p/3774954488349441 + https://github.com/multica-ai/andrej-karpathy-skills
---
