...
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/01-paradigms/ai-engineering-four-milestones-wiki/07-summary-faq-resources.md"
    title: "总结、FAQ与资源链接"
  - id: original-source
