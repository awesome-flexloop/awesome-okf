...
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/01-paradigms/harness-engineering-wiki/05-industry-benchmarks.md"
    title: "行业标杆地图"
  - id: original-source
    resource: https://mp.weixin.qq.com/s/0w_xMwto4sLx6J_85OhWQw?from=industrynews&color_scheme=light#rd
---
# 行业标杆地图
