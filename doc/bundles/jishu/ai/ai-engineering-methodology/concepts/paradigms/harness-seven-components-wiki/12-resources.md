...
type: Concept
title: "延伸资源与推荐阅读"
tags: [ai-engineering, learning, "harness", "资源", "推荐阅读", "进阶"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/01-paradigms/harness-seven-components-wiki/12-resources.md"
    title: "延伸资源与推荐阅读"
  - id: original-source
