...
tags: [ai-engineering, learning, "harness", "可观测性", "observability", "监控", "badcase"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/01-paradigms/harness-seven-components-wiki/07-observability.md"
    title: "可观测性（Observability）：数据追踪与Badcase闭环"
  - id: original-source
    resource: https://mp.weixin.qq.com/s/IOBCNtztxpinWrYW_AtYew?from=industrynews&color_scheme=light#rd
---
## 一、没有可观测性就没有Agent运营
