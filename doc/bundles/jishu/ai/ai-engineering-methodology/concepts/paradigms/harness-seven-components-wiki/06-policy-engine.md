...
tags: [ai-engineering, learning, "harness", "策略引擎", "policy-engine", "安全", "红线"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/01-paradigms/harness-seven-components-wiki/06-policy-engine.md"
    title: "策略引擎（Policy Engine）：规则红线与强制约束"
  - id: original-source
