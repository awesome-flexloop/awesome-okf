...
tags: [ai-engineering, learning, "harness", "模型网关", "model-gateway", "模型路由"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/01-paradigms/harness-seven-components-wiki/02-model-gateway.md"
    title: "模型网关（Model Gateway）：大脑调度中心"
  - id: original-source
