...
tags: [ai-engineering, learning, "harness", "agent", "业务运行底座", "七组件"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/01-paradigms/harness-seven-components-wiki/00-overview.md"
    title: "Harness业务运行底座七组件：概述与学习目标"
  - id: original-source
