...
tags: [ai-engineering, learning, "harness", "记忆系统", "memory", "上下文", "偏好"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/01-paradigms/harness-seven-components-wiki/05-memory-system.md"
    title: "记忆系统（Memory System）：便签本与档案柜"
  - id: original-source
