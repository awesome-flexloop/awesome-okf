...
tags: [ai-engineering, learning, "harness", "配置管理", "configuration", "调教", "参数"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/01-paradigms/harness-seven-components-wiki/08-configuration.md"
    title: "配置管理（Configuration Management）：持续调教面板"
  - id: original-source
