...
tags: [ai-engineering, learning, "harness", "案例分析", "文章Agent", "实战拆解"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/01-paradigms/harness-seven-components-wiki/10-case-study.md"
    title: "案例分析：文章写作Agent的Harness拆解"
  - id: original-source
