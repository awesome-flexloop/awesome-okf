...
tags: [ai-engineering, learning, "harness", "核心概念", "智能vs交付"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/01-paradigms/harness-seven-components-wiki/01-core-concepts.md"
    title: "核心概念：从智能到交付——为什么需要Harness"
  - id: original-source
