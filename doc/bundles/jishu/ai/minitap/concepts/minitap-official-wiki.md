...
description: "深度解析Minitap.ai AI驱动的移动端测试平台，核心产品minitest作为完全自主的AI QA工程师，在AndroidWorld基准测试中达到100%任务成功率（全球第一），实现零脚本、零维护、零flake的移动端测试范式革命。涵"
...
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/03-agent-platforms-tools/minitap-official-wiki.md"
