...
type: "Wiki Tutorial"
title: "资源与参考链接"
description: "ocr config set telemetry.enabled true"
tags: ["open-code-review", "ai-code-review", "alibaba"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/10-resources.md"
...
本知识库内包含多个 AI Agent 学习教程，与 Open Code Review 主题相关的 wiki 包括：
