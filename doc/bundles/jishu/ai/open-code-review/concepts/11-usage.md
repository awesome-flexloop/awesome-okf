...
type: "Wiki Tutorial"
title: "使用流程与命令详解"
description: "Open Code Review 提供两套互补的评审命令：`ocr review` 面向变更（diff）的增量评审，`ocr scan` 面向完整文件的全量扫描。本章系统介绍两条命令的使用方式、关键参数与多阶段流程。"
tags: ["open-code-review", "ai-code-review", "alibaba"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/03-usage.md"
