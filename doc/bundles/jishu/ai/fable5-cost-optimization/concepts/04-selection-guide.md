...
type: "Wiki Tutorial"
title: "场景化选型决策指南"
description: "前面三章分别介绍了社区三大开源方案和官方两大优化机制，但\"知道有哪些方法\"和\"知道什么时候用什么方法\"是两回事。本章提供实用的if-then决策逻辑，帮助你根据具体场景快速选择最合适的成本优化策略。"
tags: ["fable5", "cost-optimization", "ai-coding"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/04-selection-guide.md"
