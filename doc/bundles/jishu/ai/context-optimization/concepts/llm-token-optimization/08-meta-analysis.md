...
tags: [token-optimization, learning, "LLM", "Token", "Optimization", "Meta-Analysis", "Taxonomy", "Evolution"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/04-context-optimization/llm-token-optimization/08-meta-analysis.md"
    title: "LLM Token优化知识体系元分析"
---
# LLM Token优化知识体系元分析
