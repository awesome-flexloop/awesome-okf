...
tags: [token-optimization, learning, "LLM", "Token", "Tokenization", "Transformer", "KV-Cache", "PagedAttention", "Pricing"]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/04-context-optimization/llm-token-optimization/01-principles/00-facts.md"
    title: "大语言模型Token节省机制底层原理事实清单"
---
