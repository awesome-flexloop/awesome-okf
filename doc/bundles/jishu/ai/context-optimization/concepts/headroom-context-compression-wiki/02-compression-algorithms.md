...
type: Concept
title: "六种压缩算法详解"
tags: [token-optimization, learning]
generated: { by: "process:learning-migration", at: "2026-09-02" }
status: stable
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/04-context-optimization/headroom-context-compression-wiki/02-compression-algorithms.md"
    title: "六种压缩算法详解"
  - id: original-source
    resource: https://mp.weixin.qq.com/s/7zT5-9WDp8zi4naCC2EmOg?from=industrynews&color_scheme=light#rd
---
# Headroom — 六种压缩算法详解
