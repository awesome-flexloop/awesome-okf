...
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/04-context-optimization/headroom-context-compression-wiki/05-performance-data.md"
    title: "效果验证与数据分析"
  - id: original-source
