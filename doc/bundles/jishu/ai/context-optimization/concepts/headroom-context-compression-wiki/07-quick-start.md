...
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/04-context-optimization/headroom-context-compression-wiki/07-quick-start.md"
    title: "快速上手指南"
  - id: original-source
