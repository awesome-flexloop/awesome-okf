...
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/02-agent-engineering-methodology/04-context-optimization/headroom-context-compression-wiki/06-advanced-features.md"
    title: "跨Agent记忆与自动学习"
  - id: original-source
