...
type: "Wiki Tutorial"
title: "快速开始"
description: "本章节将引导你从零开始搭建 Anime.js 4.5 + Three.js 适配器开发环境，并完成你的第一个 3D 动画示例。"
tags: ["animejs", "threejs", "3d-animation", "webgl", "adapter-pattern"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-ai-multimodal-content/animejs-threejs-adapter-wiki/01-quickstart.md"
