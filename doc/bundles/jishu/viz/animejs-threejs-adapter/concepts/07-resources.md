...
type: "Wiki Tutorial"
title: "资源与术语表"
description: "以下为 Anime.js 与 Three.js 官方资源链接，建议收藏作为日常开发查阅参考："
tags: ["animejs", "threejs", "3d-animation", "webgl", "adapter-pattern"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-ai-multimodal-content/animejs-threejs-adapter-wiki/07-resources.md"
...
- [**原始学习分析文档**](08-article-analysis.md) — 本教程的前置学习分析，包含六大痛点、五大核心功能、代码对比与价值分析
