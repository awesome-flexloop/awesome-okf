...
type: "Wiki Tutorial"
title: "核心概念"
description: "Anime.js + Three.js 适配器的设计基于四个核心理念：适配器模式、关注点分离、API扁平化、前端知识迁移。理解这四个概念是掌握这套技术栈的关键。"
tags: ["animejs", "threejs", "3d-animation", "webgl", "adapter-pattern"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-ai-multimodal-content/animejs-threejs-adapter-wiki/02-core-concepts.md"
