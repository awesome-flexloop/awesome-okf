...
description: "Anime.js 4.5 带来了官方 Three.js 适配器（`@animejs/three`），其核心理念可以概括为一句话：“Three.js 负责渲染世界，Anime.js 负责驱动世界”。"
tags: ["animejs", "threejs", "3d-animation", "webgl", "adapter-pattern"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/05-ai-multimodal-content/animejs-threejs-adapter-wiki/00-overview.md"
...
- [学习分析文档](08-article-analysis.md) — 本教程的前置学习分析，详细梳理了 Six Pain Points、五大核心功能、代码对比、价值与局限性分析，建议在开始教程前先阅读本文建立整体认知
