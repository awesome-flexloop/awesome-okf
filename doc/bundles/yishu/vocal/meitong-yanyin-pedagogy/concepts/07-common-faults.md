...
- **练习映射**：[音阶（步骤五）](06-eight-steps-voiced.md#步骤五用发咽音方法发准确音高音阶)（小音程慢速过换声区）、[混声与换声区](03-meitong-technique.md#混声与换声区)（混声原理）、[哼咽音（步骤三）](06-eight-steps-voiced.md#步骤三哼咽音的练习)（建立过渡位置）。
