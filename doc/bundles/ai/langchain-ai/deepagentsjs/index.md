...
- [总览](/ai/langchain-ai/deepagentsjs/concepts/overview) — deepagentsjs 是什么、解决什么问题、核心能力与架构概览
- [子代理与规划](/ai/langchain-ai/deepagentsjs/concepts/subagent-planning) — handoff/fork 双模式、四类子代理、task 工具、write_todos、异步远程子代理
- [上下文与 Todo 管理](/ai/langchain-ai/deepagentsjs/concepts/context-todo) — 摘要卸载、后端抽象、filesValue 状态归约、内存/技能/权限系统

### API 参考

- [API 参考](/ai/langchain-ai/deepagentsjs/references/api) — createDeepAgent、中间件工厂、后端类、子代理类型、Harness Profile

### 使用示例

- [基础 Agent 示例](/ai/langchain-ai/deepagentsjs/examples/basic-agent) — 最简 Agent、自定义工具、子代理、文件后端、流式调用、持久化
