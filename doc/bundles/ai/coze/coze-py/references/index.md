...
- [Coze 客户端入口与基础设施参考](/references/coze-client.md) — Coze/AsyncCoze 入口类、配置常量、版本、Requester、HTTP 层、Stream、异常体系、日志、工具函数
- [认证体系参考](/references/auth-model.md) — TokenAuth、JWTAuth、OAuthApp（Web/PKCE/Device）、OAuthToken、DeviceAuthCode、Scope、load_oauth_app_from_config
