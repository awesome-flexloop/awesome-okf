...
- **[invoke](../../../../build/tooling/pyinvoke/index.md)**：任务执行框架，提供 Context、Config、Runner、Task、CLI Program 等基础设施
...
- [pyinvoke Context 对象](../../../../build/tooling/pyinvoke/index.md) — Connection 的父类
