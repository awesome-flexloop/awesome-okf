...
type: Concept
title: 对抗性审查标准与验证流程
description: 对抗性审查标准与验证流程
generated: { by: process:learning-bundles-migration, at: 2026-09-02T00:00:00Z }
status: draft
stale_after: 2027-09-02
sources:
  - id: learning-source
    resource: SpecWeave docs/knowledge/learning/00-essence-and-thinking/first-principles/00-adversarial-review-protocol.md
    title: first-principles-comprehensive-research Task 0
---
# 对抗性审查标准与验证流程
