...
本章研究训练数据趋于无穷时分类器是否收敛到 Bayes 最优，是[一致性](/datawhale/key-book/concepts/consistency)概念的主体章节。
...
- [第 7 章：收敛率](/datawhale/key-book/references/chapter7)：一致性只回答"是否收敛"，收敛率回答"多快"
- [附录](/datawhale/key-book/references/appendix)：凸函数、Jensen 不等式等数学基础
