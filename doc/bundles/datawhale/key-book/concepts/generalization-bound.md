...
- [可学性](/datawhale/key-book/concepts/learnability)：PAC 可学性本质是泛化界的直接推论
- [计算复杂度](/datawhale/key-book/concepts/computational-complexity)：泛化界的阶由 VC 维/Rademacher 复杂度决定
- [稳定性](/datawhale/key-book/concepts/stability)：提供不依赖假设空间复杂度的替代泛化保证

## 参见

- [第 4 章：泛化界](/datawhale/key-book/references/chapter4)
