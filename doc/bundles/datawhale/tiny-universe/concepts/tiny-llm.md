...
- 生成模型并列：[TinyDiffusion](/datawhale/tiny-universe/concepts/tiny-diffusion)（图像生成）
- 应用层：[TinyRAG](/datawhale/tiny-universe/concepts/tiny-rag)、[TinyAgent](/datawhale/tiny-universe/concepts/tiny-agent)

## 延伸

- 方法论根源：[白盒构建理念](/datawhale/tiny-universe/concepts/white-box-philosophy)
- 生成模型对照：[TinyDiffusion](/datawhale/tiny-universe/concepts/tiny-diffusion)
