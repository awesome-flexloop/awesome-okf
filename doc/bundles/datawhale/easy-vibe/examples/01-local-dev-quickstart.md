...
- [部署与工具链](/datawhale/easy-vibe/concepts/03-deployment-toolchain.md)：完整的构建脚本、三平台部署、电子书发布流水线。
- [多语言文档站架构](/datawhale/easy-vibe/concepts/02-multilingual-docs-architecture.md)：build-locales.mjs 的顺序构建、文件锁、base 自适应机制。
