...
description: "AI 变现术语可归为四类：财务类（衡量变现效率与健康度）、产品类（衡量产品成熟度）、市场类（衡量增长与竞争）、技术类（衡量 AI 特有的壁垒与杠杆）。下图给出 18 个核心术语的分类归属。"
tags: ["ai-monetization", "商业模式", "变现", "创业"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/06-business-trends-analysis/ai-monetization-wiki/01-core-concepts.md"
