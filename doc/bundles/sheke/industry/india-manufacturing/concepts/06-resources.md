...
type: "Wiki Tutorial"
title: "参考资料与附录"
description: "本章提供教程中引用的参考资料、术语表、七概念理论官方定义以及相关工具和资源推荐，帮助读者深入学习和应用七概念理论框架。"
tags: ["india-manufacturing", "制造业", "七概念方法论", "行业分析"]
sources:
  - id: learning-source
    resource: "docs/knowledge/learning/06-business-trends-analysis/seven-concepts-india-manufacturing-wiki/06-resources.md"
...
| 资料名称 | 来源 | 说明 |
|---------|------|------|
| 七概念理论官方定义 | seven-concepts.md（SpecWeave .agents/commands 内部命令文档，未随迁） | 七概念理论的官方定义和详细说明 |
| 复盘命令 | retrospective.md（SpecWeave .agents/commands 内部命令文档，未随迁） | 复盘命令的使用说明和最佳实践 |
| 洞察命令 | insight.md（SpecWeave .agents/commands 内部命令文档，未随迁） | 洞察命令的使用说明和分析方法 |
| 萃取命令 | extraction.md（SpecWeave .agents/commands 内部命令文档，未随迁） | 萃取命令的使用说明和模式沉淀方法 |
