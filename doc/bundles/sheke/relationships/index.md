...
type: group
title: "💕 亲密关系与两性情感"
description: "两性关系经典著作的 OKF 知识包——学术实证、哲学经典与通俗实践三个层次的亲密关系思想谱系"
tags: [relationships, intimacy, love, marriage, attachment, psychology]
---
...
```mermaid
flowchart TB
    subgraph L1["学术实证层 · 关系科学"]
        IR["intimate-relationships<br/>米勒《亲密关系》：实证教材总览"]
        AT["attached<br/>莱文《依恋》：成人依恋类型"]
        GT["gottman-seven-principles<br/>戈特曼《幸福的婚姻》：婚姻互动观察"]
    end
    subgraph L2["哲学经典层"]
        AL["art-of-loving<br/>弗洛姆《爱的艺术》：爱是能力与实践"]
    end
    subgraph L3["通俗实践层 · 附学界评价"]
        FL["five-love-languages<br/>查普曼《五种语言》：爱语表达模型"]
        MV["mars-venus<br/>格雷《火星金星》：性别差异话语（争议）"]
    end
    IR -->|"教材体系涵盖依恋专题"| AT
    IR -->|"教材体系涵盖婚姻研究"| GT
    AT -->|"依恋类型解释追逃循环"| GT
