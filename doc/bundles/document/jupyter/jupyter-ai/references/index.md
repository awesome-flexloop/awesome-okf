...
本目录包含 Jupyter AI 的源码级 API 参考文档。

| 文档 | 说明 |
|---|---|
| [元包源码参考](metapackage-source.md) | pyproject.toml 依赖、默认 MCP 工具、子模块清单 |
| [Persona API 参考](persona-api.md) | BasePersona、PersonaDefaults、process_message、entry points 注册 |
