...
本目录包含 xeus-lite-demo 各源文件的完整内容登记，作为 OKF 文档的溯源依据。

## 信源列表

| 信源文档 | 对应源文件 | 说明 |
|---------|-----------|------|
| [README 使用说明](readme-source.md) | `README.md` | 三步部署流程、内核安装示例、插件安装说明 |
| [运行时环境配置](environment-source.md) | `environment.yml` | 浏览器内 WASM 运行时的 conda 包定义 |
