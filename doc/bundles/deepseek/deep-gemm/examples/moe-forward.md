...
> **注意**：MegaMoE 仅在 Blackwell（SM100）GPU 上可用。如需在 Hopper 上运行 MoE，请使用分组 GEMM 方案（参见 [/deepseek/deep-gemm/examples/basic-gemm#分组GEMM示例](/deepseek/deep-gemm/examples/basic-gemm) 中的 M-grouped GEMM）。
...
对于非融合 MoE 方案，可以结合 [/deepseek/deep-ep/](/deepseek/deep-ep/) 进行专家并行通信：
...
- [/deepseek/deep-gemm/concepts/moe-operations](/deepseek/deep-gemm/concepts/moe-operations) — MegaMoE 设计原理
- [/deepseek/deep-gemm/concepts/grouped-gemm](/deepseek/deep-gemm/concepts/grouped-gemm) — 分组 GEMM 概念
- [/deepseek/deep-gemm/references/mega-moe](/deepseek/deep-gemm/references/mega-moe) — MegaMoE API 参考
