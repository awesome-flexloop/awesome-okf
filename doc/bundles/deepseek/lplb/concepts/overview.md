...
详见 [拓扑感知路由](/deepseek/lplb/concepts/topology-aware-routing)。
...
详见 [LP 求解器设计](/deepseek/lplb/concepts/lp-solver-design)。
...
两者互补：EPLB 处理慢时间尺度的结构性不均衡，LPLB 处理快时间尺度的 per-batch 波动。详见 [EPLB 集成](/deepseek/lplb/concepts/eplb-integration)。

## 与 Deep 生态的关系

| 组件 | 路径 | 关系 |
|---|---|---|
| DeepEP | [/deepseek/deep-ep/](/deepseek/deep-ep/) | EP 通信库，提供 all-to-all 和 NVSHMEM 通信。LPLB 复用其通信缓冲区优化 workload 同步。 |
| DeepGEMM | [/deepseek/deep-gemm/](/deepseek/deep-gemm/) | MoE grouped GEMM 计算库。LPLB 的均衡直接影响 DeepGEMM 尾延迟。 |
...
详见 [API 参考](/deepseek/lplb/references/api) 和 [基础规划示例](/deepseek/lplb/examples/basic-planning)。
...
- [负载均衡问题建模](/deepseek/lplb/concepts/load-balancing-problem)
- [LP 求解器设计](/deepseek/lplb/concepts/lp-solver-design)
- [拓扑感知路由](/deepseek/lplb/concepts/topology-aware-routing)
- [EPLB 集成](/deepseek/lplb/concepts/eplb-integration)
