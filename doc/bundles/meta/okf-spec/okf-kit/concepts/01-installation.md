...
description: "okf-kit 支持 pip/uvx 多种安装方式，最小安装无浏览器无 LLM SDK 可秒级完成，通过 7 个可选 extras 按需启用 JS 渲染/LLM 对话/LLM富化/MCP 服务/HTTP API 功能，所有用户数据存储在 `"
tags: [okf-kit, installation, pip, uvx, dependencies, optional-extras, config]
sources:
  - id: learning-source
    resource: "SpecWeave docs/knowledge/learning/03-agent-platforms-tools/okf-kit-wiki/concepts/01-installation.md"
