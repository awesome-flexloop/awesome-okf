---
type: Concept
title: Knowledge Catalog 官方示例解析
description: 官方示例知识包与示例 Agent 实战——GA4/Stack Overflow/比特币区块链/Acme Retail 四个示例 Bundle 结构解析、recipe 配方对应关系、Discovery/Enrichment 两个示例智能体的运行与组合使用。
tags: [okf, knowledge-catalog, samples, ga4, discovery-agent, enrichment-agent]
generated: { by: process:learning-bundles-merge, at: 2026-09-02T00:00:00Z }
status: draft
stale_after: 2027-09-02
sources:
  - id: src1
    resource: SpecWeave docs/knowledge/learning/01-agent-protocols-interfaces/knowledge-catalog-wiki/05-samples-and-bundles.md
    title: Knowledge Catalog Wiki 示例 Bundle 章（01 分类）
  - id: src2
    resource: SpecWeave docs/knowledge/learning/07-vendor-product-learning/google-cloud/knowledge-catalog-wiki/04-samples.md
    title: Knowledge Catalog Wiki 示例智能体章（07 分类）
---
# 05 示例Bundle深度解析
...
**OKF Wiki相关章节**：
- OKF核心概念与类型系统：okf-wiki 01 核心概念与设计哲学
- OKF快速入门（手工创建Bundle）：okf-wiki 02 5分钟快速入门
- OKF使用模式（包括认证计算模式）：okf-wiki 03 使用模式与最佳实践
