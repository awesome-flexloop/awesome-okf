...
- [总览](/langchain-ai/langchain/concepts/overview) — 核心抽象分层与架构概览
- [Runnable 协议](/langchain-ai/langchain/concepts/runnable-protocol) — 执行接口、组合原语、装饰器链与配置传播
- [消息类型体系](/langchain-ai/langchain/concepts/message-types) — BaseMessage、AIMessage、ToolMessage、ContentBlock
- [工具抽象](/langchain-ai/langchain/concepts/tool-abstraction) — BaseTool、StructuredTool、@tool、错误处理
- [提示词系统](/langchain-ai/langchain/concepts/prompt-system) — PromptTemplate、ChatPromptTemplate、PromptValue
...
- [文档与加载器](/langchain-ai/langchain/concepts/document-loader) — Document、Blob、BaseLoader

### 信源参考

- [核心抽象源码信源](/langchain-ai/langchain/references/core-abstractions) — Runnable、Serializable、RunnableConfig
- [消息与工具源码信源](/langchain-ai/langchain/references/messages-tools) — 消息体系与工具抽象
- [提示词、模型与输出解析源码信源](/langchain-ai/langchain/references/prompts-output) — Prompts、ChatModel、OutputParser、Document
- [回调、追踪与检索源码信源](/langchain-ai/langchain/references/runnables-callbacks) — Callbacks、Tracers、Retriever、VectorStore

### 使用示例

- [LCEL 基础链](/langchain-ai/langchain/examples/basic-lcel-chain) — 第一条链：提示词 → 模型 → 解析器
- [工具调用](/langchain-ai/langchain/examples/tool-calling) — 工具定义、调用与结果回传完整流程
- [RAG 检索增强生成](/langchain-ai/langchain/examples/rag-retrieval) — 文档入库、检索、接入链
