...
- [总览](/langchain-ai/langchain/concepts/overview) —— 提示词在能力层中的位置
- [Runnable 协议](/langchain-ai/langchain/concepts/runnable-protocol) —— BasePromptTemplate 是 RunnableSerializable
- [聊天模型](/langchain-ai/langchain/concepts/chat-model) —— PromptValue 是模型的输入
- [输出解析器](/langchain-ai/langchain/concepts/output-parser) —— output_parser 字段关联解析器
- [消息类型](/langchain-ai/langchain/concepts/message-types) —— ChatPromptValue 产生消息列表
