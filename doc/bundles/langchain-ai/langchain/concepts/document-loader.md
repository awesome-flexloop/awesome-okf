...
- [检索器与向量库](/langchain-ai/langchain/concepts/retriever-vectorstore) —— Document 存入 VectorStore 供检索
- [总览](/langchain-ai/langchain/concepts/overview) —— Document 在数据层中的位置
- [Runnable 协议](/langchain-ai/langchain/concepts/runnable-protocol) —— run_in_executor 实现异步适配
