...
- [模块结构索引](/langchain-ai/terraform/references/module-structure) — 四云子模块矩阵、Helm values 示例、运维脚本、CI 门禁、关键变量速查

### 源码事实与洞察

- [事实清单](/langchain-ai/terraform/spec/facts) — 56 条带文件行号的源码事实
- [架构洞察](/langchain-ai/terraform/spec/insights) — count 驱动条件编排与 plan 时 precondition 守卫网
...
| 项目 | 路径 | 关系 |
|---|---|---|
| LangSmith SDK | [/langchain-ai/langsmith-sdk/](/langchain-ai/langsmith-sdk/) | Terraform 部署的 LangSmith 平台的客户端 SDK |
| LangSmith CLI | [/langchain-ai/langsmith-cli/](/langchain-ai/langsmith-cli/) | 与部署的 LangSmith 实例交互的 CLI 工具 |
