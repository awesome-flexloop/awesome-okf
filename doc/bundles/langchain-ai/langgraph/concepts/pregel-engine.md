...
- [通道系统](/langchain-ai/langgraph/concepts/channels) — 通道类型与生命周期
- [检查点机制](/langchain-ai/langgraph/concepts/checkpointing) — 持久化在循环中的作用
- [API 参考](/langchain-ai/langgraph/references/channels-pregel) — Pregel 完整 API
