...
- [信源登记](/langchain-ai/openwork/references/source-registry) — 源码文件清单、版本与溯源映射

### 规格文档

- [事实清单](/langchain-ai/openwork/spec/facts) — 从源码提取的 26 条可验证事实
- [深度洞察](/langchain-ai/openwork/spec/insights) — 架构设计决策与安全模型分析
