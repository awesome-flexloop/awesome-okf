...
- [核心 API](/langchain-ai/deepagents/references/api) — `create_deep_agent()` 如何使用 profile
- [中间件栈](/langchain-ai/deepagents/references/middleware-stack) — profile 如何影响中间件排序和排除
