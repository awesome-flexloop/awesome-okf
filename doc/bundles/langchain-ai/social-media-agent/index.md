...
- [总览](/langchain-ai/social-media-agent/concepts/overview) — 项目定位、14 图架构、generate_post 流程、技术栈

### 参考

- [图结构参考](/langchain-ai/social-media-agent/references/graphs) — 各图节点、状态字段、条件路由、运行时配置

### 规格

- [事实清单](/langchain-ai/social-media-agent/spec/facts) — 从源码中提取的 34 条可验证事实
- [深度洞察](/langchain-ai/social-media-agent/spec/insights) — 多图架构、HITL 状态机、Send API 并行模式等 10 条设计洞察
