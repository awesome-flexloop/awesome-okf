...
- [Middleware](/langchain-ai/langchainjs/concepts/middleware) — Agent 横切扩展系统
- [消息系统](/langchain-ai/langchainjs/concepts/message-system) — AIMessage 与 ToolMessage
- [工具定义](/langchain-ai/langchainjs/concepts/tool-definition) — 工具创建
