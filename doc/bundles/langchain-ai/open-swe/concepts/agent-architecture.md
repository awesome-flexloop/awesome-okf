...
- [总览](/langchain-ai/open-swe/concepts/overview) — Open SWE 是什么
- [Dispatch-Review 循环](/langchain-ai/open-swe/concepts/dispatch-review-cycle) — durable dispatch 与 findings 模型
- [Scheduler 与 Reconcile](/langchain-ai/open-swe/concepts/scheduler-reconcile) — cron 扇出与安全网
- [架构参考](/langchain-ai/open-swe/references/architecture) — 完整函数与常量清单
