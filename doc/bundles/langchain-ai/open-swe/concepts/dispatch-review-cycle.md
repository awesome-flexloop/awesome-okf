...
- [Agent 架构](/langchain-ai/open-swe/concepts/agent-architecture) — 图工厂与 middleware 栈
- [Scheduler 与 Reconcile](/langchain-ai/open-swe/concepts/scheduler-reconcile) — cron 扇出与 baby-sit
- [总览](/langchain-ai/open-swe/concepts/overview)
- [架构参考](/langchain-ai/open-swe/references/architecture) — dispatch 与 finding 函数签名
