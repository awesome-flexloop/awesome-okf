...
type: Concept
title: 原文全录与篇目结构
description: 《鬼谷子》现存篇目原文全录（据 ctext.org 四部丛刊本与正统道藏本双列对照），含亡佚篇目存目
tags: [guiguzi, 鬼谷子, 原文, 全录, 捭阖]
...
> 本档为《鬼谷子》知识包中最重要的文档，逐字转录现存全部篇章的原文，供精读与校核。本档所录文字，均逐字转录自 ctext.org 电子底本（《四部丛刊初编》本《鬼谷子》与《正统道藏》本《鬼谷子》双列对照，ctp:gui-gu-zi），仅取中文原文列，剔除英文翻译列与链接列，保留繁体原貌，不作简体化、不改动用字。

## 底本与篇目说明

- **底本**：ctext.org《鬼谷子》，电子底本为《四部丛刊初编》本与《正统道藏》本两种（[事实22](../facts.md)）。
- **篇目结构**：《鬼谷子》今存上中下十二篇：捭阖、反应、内揵、抵巇、飞箝、忤合、揣篇、摩篇、权篇、谋篇、决篇、符言（[事实23](../facts.md)）。
- **下卷（外篇）**：含《本经阴符七术》《持枢》《中经》（[事实25](../facts.md)）。《本经阴符七术》七篇为：盛神法五龙、养志法灵龟、实意法螣蛇、分威法伏熊、散势法鸷鸟、转圆法猛兽、损兑法灵蓍（[事实26](../facts.md)）。
- **残篇与亡佚**：《持枢》为残篇，道藏本注称「此持枢之术，恨太简促，畅理不尽，或编篇既烂，不能全也」（[事实27](../facts.md)）；第十三篇《转丸》、第十四篇《胠乱》亡佚，仅存篇目（[事实24](../facts.md)），见文末「亡佚篇目存目」。
- **分段说明**：每篇原文按 ctext.org 的段落编号逐段转录。少数底本分页造成的跨段拆分（如《捭阖》「聖人一守」与「司其門戶」分列两段，《符言》各节末「右主某」标记）均系底本原貌，照录不并、不改。
...
> 《本經陰符七術》为《鬼谷子》下卷（外篇）主体，七篇依次为：盛神法五龙、养志法灵龟、实意法螣蛇、分威法伏熊、散势法鸷鸟、转圆法猛兽、损兑法灵蓍（[事实26](../facts.md)）。以下逐术转录。
...
> 本篇为残篇：道藏本注称「此持枢之术，恨太简促，畅理不尽，或编篇既烂，不能全也」（[事实27](../facts.md)），原文即此一段。
...
《鬼谷子》原书另有以下两篇亡佚，仅存篇目，无正文传世（[事实24](../facts.md)）：
...
> 说明：ctext.org《鬼谷子》目录页中「轉丸」「胠亂」两目亦仅列篇名、无链接与正文，与本档「仅存目、无原文」的判断一致。读者如需进取，可参考[历代注家与立场](05-commentaries.md)中现代校注本（如许富宏《鬼谷子集校集注》等）对亡佚篇目的考辨。